...
skills = [
  ...
  ("engineer","Engineering",sf_base_att_int|sf_effects_party,10,"This skill allows you to construct siege equipment and fief improvements more efficiently. (Party skill)"),
  ...
  ("reserved_5","Sieging",sf_base_att_int|sf_effects_party,10,"Inceases your options and effectiveness during sieges (not yet implemented)."), 
  ...
  ("looting","Spoils of War",sf_base_att_agi|sf_effects_party,10,"This skill increases the amount of loot obtained by 10%% per skill level. (Party skill)"), 
  ("horse_archery","Mounted Marksmanship",sf_base_att_agi,10,"Reduces damage and accuracy penalties for muskets, pistols, bows, and thrown items from horseback. (Personal skill)"),
  ...
  ("reserved_13","Foraging",sf_base_att_agi|sf_effects_party,10,"Grants your party the ability to live off the land with effective food gathering (not yet implemented)."), 
  ("power_draw","Archery",sf_base_att_str,10,"Lets character use more powerful bows. Each point to this skill (up to four plus power-draw requirement of the bow) increases bow damage by 14%%. (Personal skill)"),
  ("power_throw","Throwing",sf_base_att_str,10,"Each point to this skill increases throwing damage by 10%%. (Personal skill)"),
  ("power_strike","Fencing",sf_base_att_str,10,"Each point to this skill increases melee damage by 8%%. (Personal skill)"),
