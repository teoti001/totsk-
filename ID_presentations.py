...
prsnt_equipment_overview = 44
prsnt_companions_overview = 45
prsnt_character_creation = 46
prsnt_dplmc_autoloot_upgrade_management = 47
prsnt_dplmc_policy_management = 48
prsnt_dplmc_peace_terms = 49
prsnt_jrider_faction_relations_report = 50
prsnt_dplmc_set_vassal_title = 51
prsnt_dplmc_auto_sell_options = 52
prsnt_dplmc_shopping_list_of_food = 53
prsnt_jrider_character_relation_report = 54
prsnt_prebattle_custom_deployment = 55
prsnt_prebattle_orders = 56
prsnt_pbod_preferences = 57
prsnt_pbod_redefine_keys = 58
prsnt_caba_order_display = 59
prsnt_caba_camera_mode_display = 60
prsnt_prebattle_custom_divisions = 61
