...
##    
 ...
 #   ),
    ...
    ("musket_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_a", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
     100, 13, 1.8, -0.00203, 90, 2.25,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.98), (0.94, 0),       #alpha keys
     (0.0, 0.99), (1, 0.99),      #red keys
     (0.0, 0.99),(1, 0.99),       #green keys
     (0.0, 0.99), (1, 0.99),      #blue keys
     (-0.09, 3.2),   (0.5, 11.0),   #scale keys
     (0.05, 0.05, 0.05),           #emit box size
     (0.0, 4.6, 0.0),                 #emit velocity
     0.7,                        #emit dir randomness
     90,                       #rotation speed
    ...
    ("firearm_flash", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     100, 0.2, 0.2, 0.03, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.7),(1, 0.3),       #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
    ...
    ("pan_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prtcl_dust_a", # psf_global_emit_dir psf_billboard_3d | psf_randomize_size psf_always_emit
     60, 5, 1.8, -0.0003, 90, 4.00,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.83), (0.78, 0),       #alpha keys
     (0.0, 0.99), (1, 0.99),      #red keys
     (0.0, 0.99),(1, 0.99),       #green keys
     (0.0, 0.99), (1, 0.99),      #blue keys
     (-0.07, 1.0),   (0.5, 3.75),   #scale keys
     (0.02, 0.02, 0.02),           #emit box size
     (-1.2, 0.5, 0.0),                 #emit velocity
...
#-*-*-*- Village Fire *-*-*-*-#
	...
	("explosion", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     35, 0.6, 0, -0.4, 25.0, 10.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.7), (1, 0),        #alpha keys
     (0.2, 1.0), (1, 0.9),      #red keys
     (0.2, 0.7),(1, 0.3),       #green keys
     (0.2, 0.2), (1, 0.0),      #blue keys
