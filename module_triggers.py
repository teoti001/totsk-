...
#    ]),
  ...
  [
    (set_spawn_radius, 1),
    (store_add, ":p_town_70_plus_one", "p_town_70", 1),
    (store_random_in_range, ":selected_town", "p_town_1", ":p_town_70_plus_one"),
     ...
     (try_for_range, ":companion", companions_begin, companions_end),
       ...
       (try_for_range, ":i_slot", 0, ":inv_cap"),
		 ...
		 (ge, ":item_id", 0),
	 	 ...
	 	 (this_or_next|eq, ":item_id", "itm_rapier_1"),
	 	 (this_or_next|eq, ":item_id", "itm_spanish_broadsword"),
		 (eq, ":item_id", "itm_russian_shashka"),
