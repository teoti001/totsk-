  ...
  ("store_battlegroup_data", [
	...
	(try_for_agents, ":cur_agent"),
		...
		(try_begin),
			...
			(item_get_weapon_length, ":cur_weapon_length", ":cur_weapon"), #WSE

			#(item_get_slot, reg0, ":cur_weapon", slot_item_thrust_damage),
			#(item_slot_ge, ":cur_weapon", slot_item_swing_damage, reg0),
			(item_get_thrust_damage, reg0, ":cur_weapon"), #WSE
			(item_get_swing_damage, reg1, ":cur_weapon"), #WSE
			(gt, reg1, reg0),
...
# # Autoloot improved by rubik begin
  ...
  ("get_item_score_with_imod", [
    ...
    (else_try),
	  ...
	  (item_get_horse_speed, ":horse_speed", ":item"), #WSE
	  (item_get_body_armor, ":horse_armor", ":item"), #WSE
	  (item_get_horse_charge_damage, ":horse_charge", ":item"), #WSE
    ...
    (else_try),
	  ...
	  (item_get_shield_height, ":shield_size", ":item"), #WSE
	  (item_get_body_armor, ":shield_armor", ":item"), #WSE
	  (item_get_speed_rating, ":shield_speed", ":item"), #WSE
    ...
    (else_try),
	  ...
	  (item_get_head_armor, ":head_armor", ":item"), #WSE
	  (item_get_body_armor, ":body_armor", ":item"), #WSE
	  (item_get_leg_armor, ":leg_armor", ":item"), #WSE
    ...
    (else_try),
	  ...
	  (item_get_speed_rating, ":item_speed", ":item"), #WSE
	  (item_get_weapon_length, ":item_length", ":item"), #WSE
	  (item_get_swing_damage, ":swing_damage", ":item"), #WSE
	  (item_get_thrust_damage, ":thrust_damage", ":item"), #WSE
    ...
    (else_try),
      ...
      #(item_get_slot, ":thrust_damage", ":item", slot_item_thrust_damage),
	  (item_get_thrust_damage, ":i_score", ":item"), #WSE
	  
      #(val_mod, ":thrust_damage", 256), #WSE
      #(assign, ":i_score", ":thrust_damage"), #WSE
