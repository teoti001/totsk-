...
game_menus = [
  ("start_game_0", 0,
    "The year is 1702. Europe is in turmoil. It has become home to an eternal battlefield; host to a graveyard of broken dreams, blood, and lives. For the past four decades Europe has been embroiled in constant warfare with Louis XIV, the Sun King, keeping the fires of war burning. Alliances have been made. Banners have been raised. Rapiers have been sharpened, cannons loaded, and muskets readied. The land trembles as armies prepare to march. Northern Europe is aflame with Baltic disputes. What role will you serve as Europe goes to war during the Twilight of the Sun King?",
    "none",
    [],
    [
      ("choose_options", [],
  ...
  ("start_phase_2",mnf_disable_all_keys,
    "Walking out the door of the tavern, you begin your journey across Europe, a land presently torn between rival royal dynasties battling each other for supremacy,\
 a haven for warmongers and mercenaries, cutthroats and merchants, all willing to risk their lives in pursuit of fortune, power, or glory...\
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about these wars and their kingdoms, you...",
    "none",
    [],
    [
      ("town_1",[(eq, "$current_startup_quest_phase", 0),],"take a carriage to Paris, in the Kingdom of France.",
       [
...
#         (change_screen_return),
      ...
      ("town_2",[(eq, "$current_startup_quest_phase", 0),],"take a ship to London, within Great Britain.",
       [
...
#         (change_screen_return),
      ...
      ("town_3",[(eq, "$current_startup_quest_phase", 0),],"take a carriage to Vienna, within the Holy Roman Empire.",
       [
...
#         (change_screen_return),
      ...
      ("town_4",[(eq, "$current_startup_quest_phase", 0),],"take a carriage to Munich, within the Electorate of Bavaria.",
       [
...
#         (change_screen_return),
      ...
      ("town_5",[(eq, "$current_startup_quest_phase", 0),],"take a ship to Den Haag, within the United Provinces.",
       [
...
#         (change_screen_return),
      ...
      ("town_6",[(eq, "$current_startup_quest_phase", 0),],"take a carriage to Madrid, within the Kingdom of Bourbon Spain.",
       [
...
#         (change_screen_return),
      ...
      ("tutorial_cheat",[(eq,1,0)],"{!}CHEAT!",
       [
         ...
         (party_add_members, "p_main_party", "trp_swiss_captain", 10),
         (party_add_members, "p_main_party", "trp_serbian_irregular", 10),
         (party_add_members, "p_main_party", "trp_hired_blade", 10),
         (party_add_members, "p_main_party", "trp_mercenary_cavalry", 10),
         (troop_add_item, "trp_player","itm_village_poleaxe_5",0),
         (troop_add_item, "trp_player","itm_prussian_musket_bayonet",0),	 
...
##      ]),
      ...
      [
        ...
        (troop_clear_inventory, "$g_player_troop"),
        (troop_add_item, "$g_player_troop","itm_dueling_shirt",0),
        (troop_add_item, "$g_player_troop","itm_gentlemens_shoes",0),
        (troop_add_item, "$g_player_troop","itm_practice_sword",0),
        (troop_add_item, "$g_player_troop","itm_quarter_staff",0),
        (troop_equip_items, "$g_player_troop"),
        (set_visitor,0,"trp_player"),
...
##diplomacy end+		
  ...
  (
    ...
    "You were born into a Europe on the cusp of greatness and destruction. Your father was...",
    "none",
    [
    (str_clear,s10),
    (str_clear,s11),
    ...
    [
    ("start_noble",[],"A Minor Noble",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You were born the {reg3?daughter:son} of family on whose name has command respect throughout the area,\
 owning a modest manor in which they lived. Your family stressed the importance of the Trivium and Quadrivium,\
 gaining you you a proper education and tutor, training you from childhood for the life of aristocracy and courts."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_merchant",[],"A Mercenary",[
      (assign,"$background_type",cb_merchant),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You were born the {reg3?daughter:son} of a battle-scared mercenary, a veteran of numerous European wars.\
 Always moving from place to place in search of a profit, your father brought your family on every campaign. Although your parents were wealthier than most\
 and educated you as well as they could, you found little opportunity to make friends on the road.\
 Despite your mother's complaints, your father taught how to use a musket, blade, and netted the family quite a purse before his death upon a field."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_guard",[],"A Decorated Officer",[
      (assign,"$background_type",cb_guard),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@As a child, your family rarely saw your father, as he was a decorated officer and veteran of the Great Turkish Wars,\
 constantly away from home. It was not an easy existence, and you were too poor to get much of an\
 education. When he was around, he spared little time in assuring your ability with a musket and rapier."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_forester",[],"A Peasant",[
 ...
 doing whatever they needed to make ends meet. Hunting, woodcutting, making bullets, even a spot of poaching whenever things got tight.\
 Peas, hard bread, wild game, and farming were all you knew. Your siblings died young, and you were left the only child. \
 The cold took animals and people alike, but you always lived to see another dawn,though your brothers and sisters were not to be so fortunate.\
 With an old musket and sword, your father scraped by on what he could."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_nomad",[],"A Soldier.",[
      (assign,"$background_type",cb_nomad),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@{reg3?daughter:son}"),
      (str_store_string,s10,"@You were a child of a soldier of the Polish Wars in the 17th century. You never met him, as you were an illegimate child of indiscretions.\
 You and your mother travelled in great camps throughout Eastern Europe, trying to escape the constant warfare in Poland and the Balkans.\
 Horses were something of a mainstay for you, as you were constantly on the run as the nobles of Europe tore at each other. Your ability with them is natural.\
 Your father left your mother some of his items before leaving one night. It is not much, but you seem to have inherited your father's penchant for war-making."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_thief",[],"A Clergyman.",[
      (assign,"$background_type",cb_thief),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@As the {reg3?daughter:son} of a cleric, you had very little 'formal' education.\
 Instead you were given strict religious lessons which you still hold dear. Devout in their faith, you were taken to services regularly.\
 Your family lived modestly and was greatly respected by your local villagers. Rarely did anyone have a negative statement to issue about them.\
 Even now, you still feel driven by a need to carry out God's will, with modesty and humility."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
...
##    ]),
  ...
  (
    "start_character_2",0,
    "{s10}^^ Those earlier days were not as clear as your childhood, however. You spent your early life as...",
    "none",
    [],
    [
      ("page",[
          ],"A Child Of Many Courts.",[
      (assign,"$background_answer_2", cb2_page),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 you were sent to live in the court of one of the nobles of Europe. You did not particularly care for your parents, anyway.\
 There, your first lessons were in the divine right of kings, as you waited upon the lords and ladies of the household.\
 ...
 and competition. You also learned from the rough games of the other children, who battered at each other with sticks in imitation of their elders' blades."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("apprentice",[
          ],"A Gunsmith's Apprentice.",[
      (assign,"$background_answer_2", cb2_apprentice),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood, with your father's connections\
 you apprenticed with a renown gunsmith to learn metallurgy and attention to detail. After years of hard work and study under your\
 new master, he promoted you to journeyman and employed you as a fully paid gunsmith for as long as\
 you wished to stay. You became quite learned in the ways of gunsmithing, blacksmithing, and whitesmithing as a result."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("stockboy",[
          ],"A Merchant's Assistant.",[
      (assign,"$background_answer_2",cb2_merchants_helper),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Due to your charisma and fondness for numbers, as a young {reg3?girl:boy}, you family managed to\
 you apprenticed to a wealthy merchant, picking up the trade over years of working shops and making long distance trade routes.\
 You soon became adept at the art of buying low, selling high, and leaving the customer thinking they'd\
 gotten the better deal. You were often the first to recieve new gifts from the exotic new imperial possessions."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("urchin",[
          ],"A Child Of Religion.",[
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Working with your family's faith, you eagerly sought to serve God and his will. You were a regular at your center of faith.\
 You adored the time spent with friends, running in the acres around the center in between lessons.\
 The family's friends took notice and admired you for it. Nearly everywhere you travelled, your books came with you.\
 War was decisively condemned in your household, but you secretly trained with a local religious order."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("nomad",[
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@With a bedraggled horse, as a {reg3?girl:boy} growing out of childhood,\
 you travelled all across the Austrian Empire and war-torn Balkans, the child of a Gypsy and Cossack.\
 Hated by nearly everyone, you sometimes went hungry, though you became a skillful hunter and pathfinder in the hilly Balkans.\
 Your body too started to harden with muscle as you grew into the life of a poor Cossack {reg3?woman:man}."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
...
##        ]),
      ...
      ("squire",[(eq,"$character_gender",tf_male)],"An Officer Cadet.",[
        (assign,"$background_answer_3",cb3_squire),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s12,"@As the years wore on, you grew into your own, and\
 somewhere along the way you had become a {reg3?woman:man}. It was refreshing, yet came with responsiblities.\
 Men of means had taken note of your skill with a rapier and musket, your valor and leadership,\
 recommending you a commission in a cadet's college for officers.\
 You were instructed in your obligations to your superiors, and of your duties to those who might one day be under your command.\
 You learnt the ways and means of both war and court, lessons of which you were keen to note.\
 Reared in texts on fortifications, drill manuals and arms, you learnt history and politics,\
 and how to use them to your own ends as for your nation. You quickly discared these notions and set out on your own."),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("lady",[(eq,"$character_gender",tf_female)],"A courtesan.",[
 ...
 with a little bit of subtlety. Plying men for gain gained you an uncanny prowess in the ways of love."),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("troubadour",[],"A Mercenary.",[
        (assign,"$background_answer_3",cb3_troubadour),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@After squandering your finances in your youth, you decided it was time that\
 somewhere along the way you become a {s13}. With a Matchlock and rapier in hand, you joined a German Mercenary regiment.\
 Your valor and knowledge of the field quickly made you respected amongst your peers and you became something of a leader.\
 An expert shot with a well-made musket you harvested from a man you fell, you managed quite a living as a man killer,\
 drinking the nights away with your fellow soldiers of fortune. You were young, ambitious and soon some in the group took your\
 position from you, by force. Quickly escaping before you were shot, you snuck out at night with everything you could take with you."),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("student",[],"A Well-Educated Student.",[
        (assign,"$background_answer_3",cb3_student),
      (str_store_string,s12,"@Your connections proved well on your path to becoming a {reg3?woman:man},\
 even though if you were something of a waif, alone and seemingly orphaned by being away at university.\
 You managed to secure a spot in the University of Paris, paying your way with odd jobs,\
 where you studied theology, philosophy, and medicine. Learned you became, but mannered you were not.\
 Many of your lessons were learned in the lecture halls.\
 However, you may or may not have joined in with your fellows as they roamed the alleys in search of wine, women, and a good fight.\
 To be sure, you certainly were able to observe how a broken jaw is set,\
 or how an angry townsman can be persuaded to set down his club and accept cash compensation for the destruction of his shop."),
	(jump_to_menu,"mnu_start_character_4"),
      ...
      ("peddler",[],"An Accomplished Merchant.",[
        (assign,"$background_answer_3",cb3_peddler),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@With the United Provinces getting involved in global trade,\
 somewhere along the way you had become a {s13}, and a merchant in the thriving marketplace of Holland.\
 Heeding the call of the open road, you travelled from village to village buying and selling what you could.\
 It was quite the existence, and you became a master at haggling even the most miserly citizens into\
 giving you a good price. Soon, you knew, you would be well-placed to start your own trading empire..."),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("craftsman",[],"A Smith Of Metals.",[
        (assign,"$background_answer_3", cb3_craftsman),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 You pursued a career as a smith, crafting items of function and beauty out of simple metals.\
 Copper, tin, iron all became as familiar to you as your family. Gunsmithing, blacksmithing, whitesmithing.\
 ...
 With food in your belly and logs on your fire, you could take pride in your work and your growing reputation."),
	(jump_to_menu,"mnu_start_character_4"),
      ...
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Others in their youth took to fun games and learning a trade,\
 but you had decided that all of the business in being a stand-up member of society was droll.\
 Dissatisfied with common men's desperate scrabble for coin, you took to robbery and violence, plying people of their goods.\
 Louis XIV's Inspecteurs de Police were always after you. Learning your trade from Italian masters,\
 you learnt where a stiletto was to go and were the poverbial robber in the night. You fell in with local gangs\
 and became something of a proud member. While some slept, you and your partners in crime divided up the shares of loot and bount."),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
...
##        ]),
  ...
  (
    ...
    [],
    [
      ("revenge",[],"Getting Back At Those Who Hurt You.",[
        (assign,"$background_answer_4", cb4_revenge),
      (str_store_string,s13,"@One night your best friend was found slain in the street. You realised it was time to strike it out before long.\
 ...
 and these debts can only be paid in blood...and you intend to find it."),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("death",[],"The Murder Of Your Bethrothed.",[
        (assign,"$background_answer_4",cb4_loss),
      (str_store_string,s13,"@On a beautiful night in February 1701, your betrothed was shot in a midnight scuffle.\
 The pain ran deep,and you couldn't bear to stay, not with the memories of the one you loved so close and so\
 recent. Perhaps your new life will let you forget, allow you to put down the bottle\
 or honour the name that you can no longer bear to speak..."),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("wanderlust",[],"An Inner Desire For Adventure.",[
        (assign,"$background_answer_4",cb4_wanderlust),
      (str_store_string,s13,"@Some are born to dutifully work at a task, others are destined to roam.\
 You're not even sure when your home became a prison, when the familiar became mundane, but your dreams of\
 wandering have taken over your life. You spend nights reading about the exotic Ottoman Empire and the fascinating exploits of France's elite,\
 musing on the freedom to travel, you could no longer bear to stay in the same place. Maybe the foreign legions of Europe\
 have a place for you. You looked at the door, picked up your hat, and jumped on your horse..."),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
...
##        (jump_to_menu,"mnu_choose_skill"),
##        ]),
      ("disown",[],"Your Family Disowned You.",[
        (assign,"$background_answer_4",cb4_disown),
      (str_store_string,s13,"@Despite it all, your family was the dearest thing to you. However, you took it too far one night,\
 having daliances with a powerful noble's {daughter/son}. You know you cannot go back. There's nothing to go back to. Whatever home you may have had is gone\
 now, and you must face the fact that you're out in the wide wide world. Alone to sink or swim..."),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
     ("greed",[],"Greed, Power, And Ambition.",[
        (assign,"$background_answer_4",cb4_greed),
      (str_store_string,s13,"@In the end, it was being the one in control, the one with the most money, and the highest honours that moved you the most.\
 To everyone else, it's clear that you're now motivated solely by personal gain.\
 You want to be rich, powerful, respected, feared, perhaps a king of your own dynasty.\
...
##        (jump_to_menu,"mnu_past_life_explanation"),
##        ]),
      ("begin_adventuring",[],"Your life is now your own. Live it...",[
           (set_show_messages, 0),
           (try_begin),
...
##diplomacy end
      ("camp_action",[],"Take an action.",
	   ...
	   ("regiment_info",[],"Regiment information.",
       [(jump_to_menu, "mnu_regiment_information"),
        ]
       ),
          ...
          (else_try),            
            ...
            ##diplomacy end
              ...
              (else_try), #player took a walled center for player's kingdom
                ...
                (assign, ":best_troop", "trp_militia_sergeant"),
				##diplomacy start+
    ...
    [
      ...
      # [
       ...
       # [
         ...
         # (try_end),
        # ]),
      ("recruiter_talk",[(neg|party_slot_eq, "$current_town", slot_village_state, svs_looted),
                         (neg|party_slot_eq, "$current_town", slot_village_state, svs_being_raided),
                         (neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
		],
       "Speak with the local Recruiter.",
       [
		   (party_get_slot, ":village_scene", "$current_town", slot_castle_exterior),
           (modify_visitors_at_site,":village_scene"),
           (reset_visitors),
           (faction_get_slot, ":recruiter", "$g_encountered_party_faction", slot_faction_recruitment_officer),
           (set_visitor, 11, ":recruiter"),
           (jump_to_scene, ":village_scene"),
           (change_screen_map_conversation, ":recruiter"),        
        ]),
       ...
       [
         ...
         (else_try),
          ...
          (try_end),
           ...
           (call_script, "script_init_town_walkers"),
		   (assign, "$party_to_remove_from", "$current_town"),
		   
		   (try_begin),
		     (party_slot_eq, "$current_town", slot_center_has_church, 1),
			 #(party_get_slot, ":village_elder_troop", "$current_town",slot_town_elder),
		     (set_visitor, 15, "trp_fugitive"),
		   (try_end),
		   (try_begin),
		     (party_slot_eq, "$current_town", slot_center_has_weaponsmith, 1),
			 (party_get_slot, ":village_weaponsmith", "$current_town", slot_town_weaponsmith),
		     (set_visitor, 16, ":village_weaponsmith"),
		   (try_end),
		   (try_begin),
		     (party_slot_eq, "$current_town", slot_center_has_clothier, 1),
			 (party_get_slot, ":village_armorsmith", "$current_town", slot_town_armorer),
		     (set_visitor, 17, ":village_armorsmith"),
		   (try_end),
		   (try_begin),
		     (party_slot_eq, "$current_town", slot_center_has_stables, 1),
			 (party_get_slot, ":village_horse_merchant", "$current_town", slot_town_horse_merchant),
		     (set_visitor, 18, ":village_horse_merchant"),
		   (try_end),
		   (try_begin),
		     (party_slot_eq, "$current_town", slot_center_has_market, 1),
			 (party_get_slot, ":village_merchant", "$current_town", slot_town_merchant),
		     (set_visitor, 19, ":village_merchant"),
		   (try_end),
		   # (try_begin),
		     # (party_slot_eq, "$current_town", slot_center_has_market, 1),
			 # (party_get_slot, ":village_elder_troop", "$current_town",slot_town_merchant),
		     # (set_visitor, 20, "trp_fugitive"),
		   # (try_end),
      ...
      ("village_tavern",[
            ...
            (neg|party_slot_eq, "$current_town", slot_village_state, svs_being_raided),
            (neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
			(party_slot_eq, "$current_town", slot_center_has_tavern, 1),
...
#          (scene_slot_eq, ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       [
           ...
           (else_try),
			 ...
			 ##how the hell is this set in towns?
			 (party_get_slot, ":tavern_keeper", "$current_town", slot_town_tavern),
			 (set_visitor, ":tavern_keeper", 9),
			 
             (assign, ":cur_entry", 17),
			  
			 (store_random_in_range, ":whore", tavern_women_begin, tavern_women_end),
			 (set_visitor, ":cur_entry", ":whore"),
			 (val_add, ":cur_entry", 1),
      ...
      ("trade_with_merchants",
       [
           ...
           (neg|party_slot_eq, "$current_town", slot_village_state, svs_being_raided),
           (neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
		   (this_or_next|party_slot_eq, "$current_town", slot_center_has_weaponsmith, 1),
		   (this_or_next|party_slot_eq, "$current_town", slot_center_has_clothier, 1),
		   (this_or_next|party_slot_eq, "$current_town", slot_center_has_stables, 1),
		   (party_slot_eq, "$current_town", slot_center_has_market, 1),
        ],
...
##diplomacy end+
      ...
      # ("regiment_managment",
       ...
       # [
	     # (jump_to_menu,"mnu_regiment_recruitment"),
...
#           (party_add_template, "$current_town", "pt_villagers_in_raid"),
 ...
 currently building {s7}. The building will be completed after {reg8} day{reg9?s:}.:}",
    ...
    [
	  ...
	  ("central_build_church", 
	  [
		(eq, reg6, 0),
		(this_or_next|party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
		(party_slot_eq, "$g_encountered_party", slot_center_has_church, 0),
	  ],
	  "Build a new church",
	  [
		(assign, "$g_improvement_type", slot_center_has_church),
		(jump_to_menu, "mnu_center_improve"),
	  ]),
	  
	  ("central_build_tavern", 
	  [
		(eq, reg6, 0),
		(this_or_next|party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
	  ...
	  "Build a new tavern",
	  [
		(assign, "$g_improvement_type", slot_center_has_tavern),
		(jump_to_menu, "mnu_center_improve"),
	  ]),
	  
	  ("central_build_market", 
	  [
		(eq, reg6, 0),
		(this_or_next|party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
	  ...
	  "Build a new market",
	  [
		(assign, "$g_improvement_type", slot_center_has_market),
		(jump_to_menu, "mnu_center_improve"),
	  ]),
	  
	  ("central_build_weaponsmith", 
	  [
		(eq, reg6, 0),
		(this_or_next|party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
		(party_slot_eq, "$g_encountered_party", slot_center_has_weaponsmith, 0),
	  ],
	  "Build a new weaponsmithy",
	  [
		(assign, "$g_improvement_type", slot_center_has_weaponsmith),
		(jump_to_menu, "mnu_center_improve"),
	  ]),
	  
	  ("central_build_clothier", 
	  [
		(eq, reg6, 0),
		(this_or_next|party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
		(party_slot_eq, "$g_encountered_party", slot_center_has_clothier, 0),
	  ],
	  "Build a new clothier",
	  [
		(assign, "$g_improvement_type", slot_center_has_clothier),
		(jump_to_menu, "mnu_center_improve"),
	  ]),
	  
	  ("central_build_stables", 
	  [
		(eq, reg6, 0),
		(this_or_next|party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
      ...
      "Take a walk around the streets.",
       [
         ...
         (try_begin),
		   ...
		   (faction_get_slot, ":tier_1_troop", ":town_faction", slot_faction_tier_1_troop),
           ...
           (try_begin), 
             ...
             (try_begin), #there are 6 guards at day time (no fire ext)
               (ge, ":cur_day_hour", 6),
               (lt, ":cur_day_hour", 22),
               (set_visitors, 25, ":tier_1_troop", 2),
               (set_visitors, 26, ":tier_2_troop", 1),
               (set_visitors, 27, ":tier_3_troop", 1),
               (set_visitors, 28, ":tier_4_troop", 2),
         ...
         (else_try),
           ...
           (else_try),
             ...
             (assign,reg2,"trp_hired_blade"),
             (assign,reg3,"trp_militia_corporal"),
           (try_end),
           (shuffle_range,0,4),
           ...
           (call_script, "script_init_town_walkers"),
		   (try_begin),
               (faction_get_slot, ":spawned_troop", ":town_faction", slot_faction_recruitment_officer),
               (gt, ":spawned_troop", 0),
               (set_visitor, 39, ":spawned_troop"),
           (try_end),
           (set_jump_mission,"mt_town_center"),
...
#          (scene_slot_eq, ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       [
			# (try_for_range, ":lord", lords_begin, lords_end),
			  # (troop_get_slot,":reg", ":lord", slot_regiment),
			  # # (party_get_slot, reg1, ":reg", slot_base_regiment_size),
			  # # (display_message, "@regiment size: {reg1}"),
			  # (lt, ":reg", 1),
			  # (str_store_troop_name, s0, ":lord"),
			  # (display_message, "@Idiot does not have regiment {s0}"),
			# (try_end),
			# (try_for_range, ":fac", "fac_kingdom_1", "fac_kingdoms_end"),
			  # (faction_get_slot, ":inf", ":fac", slot_faction_inf_reg),
			  # (faction_get_slot, ":cav", ":fac", slot_faction_cav_reg),
			  # (assign, reg0, ":inf"),
			  # (assign, reg1, ":cav"),
			  # (display_message, "@inf id: {reg0}"),
			  # (display_message, "@cav id: {reg1}"),
			# (try_end),
			# (display_message, "@historical-----------------------------------------"),
			# (try_for_parties, ":party"),
			  # (party_slot_eq, ":party", slot_party_type, spt_historical_regiment),
			  # (party_get_slot, ":troop", ":party",slot_base_troop),
			  # (str_store_troop_name,s0, ":troop"),
			  # (display_message, "@{s0}"),
			# (try_end),
			# (display_message, "@actual---------------------------------------------"),
			# (try_for_parties, ":party"),
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
			 ...
			 (try_begin),
               (party_get_slot, ":tavern_chaplain", "$current_town", slot_center_tavern_chaplain),
               (gt, ":tavern_chaplain", 0),
               (set_visitor, ":cur_entry", ":tavern_chaplain"),
               (val_add, ":cur_entry", 1),
             (try_end),
			 #Refugee
			 (try_begin),
               (party_get_slot, ":tavern_czech_refugee", "$current_town", slot_center_tavern_czech_refugee),
               (gt, ":tavern_czech_refugee", 0),
               (set_visitor, ":cur_entry", ":tavern_czech_refugee"),
               (val_add, ":cur_entry", 1),
             (try_end),
			 
			 (try_begin),
               (party_get_slot, ":tavern_hungarian_refugee", "$current_town", slot_center_tavern_hungarian_refugee),
               (gt, ":tavern_hungarian_refugee", 0),
               (set_visitor, ":cur_entry", ":tavern_hungarian_refugee"),
               (val_add, ":cur_entry", 1),
			 (try_end),
			 
			 (try_begin),
               (party_get_slot, ":tavern_croatian_refugee", "$current_town", slot_center_tavern_croatian_refugee),
               (gt, ":tavern_croatian_refugee", 0),
               (set_visitor, ":cur_entry", ":tavern_croatian_refugee"),
               (val_add, ":cur_entry", 1),
			 (try_end),
			 
			 (try_begin),
               (party_get_slot, ":tavern_austrian_refugee", "$current_town", slot_center_tavern_austrian_refugee),
               (gt, ":tavern_austrian_refugee", 0),
               (set_visitor, ":cur_entry", ":tavern_austrian_refugee"),
               (val_add, ":cur_entry", 1),
			 (try_end),
			 
			 (try_begin),
               (party_get_slot, ":tavern_jacobite_refugee", "$current_town", slot_center_tavern_jacobite_refugee),
               (gt, ":tavern_jacobite_refugee", 0),
               (set_visitor, ":cur_entry", ":tavern_jacobite_refugee"),
               (val_add, ":cur_entry", 1),
			 (try_end),
			 #Refugee
			 (try_begin),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
      ...
      [
       ...
       [
         ...
         (else_try),                   
           ...
           (set_visitor, 24, ":troop_prison_guard"),
			 (try_begin),
               (faction_get_slot, ":castle_recruitment_officer", "$g_encountered_party_faction", slot_faction_recruitment_officer),
               (gt, ":castle_recruitment_officer", 0),
               (set_visitor, 16, ":castle_recruitment_officer"),
             (try_end),           
           (assign, ":guard_no", 40),
      ...
      ("town_recruitment",
       ...
       "Visit the cannon foundry.",
       [
	     (jump_to_menu,"mnu_cannon_recruitment"),
...
#			(troop_slot_eq, ":lady_guardian", slot_lord_granted_courtship_permission, -1),
	...
	(gt, "$love_interest_in_town", 0),
      ...
      ("recruiter_talk",[#(eq, "$g_encountered_party_faction", "$players_kingdom"),
		],
       "Speak with the local Recruiter.",
       [
           (try_begin),
...
####################################################################################################################################
  ##drtomas
    ...
    (
    "cannon_recruitment",0,
    "Currently you have {reg1} cannons in the party: {reg2} three pound, {reg3} six pound, {reg4} twelve pound. You currently can own up to {reg5} cannons.",
    "none",
    [
	  (call_script, "script_get_cannon_count", "p_main_party"),
	  (assign, reg10, 3000),
	  (assign, reg11, 6000),
	  (assign, reg12, 12000),
	],
    [
	  ...
	  [
       ...
       "Recruit three pound cannon. Cost: {reg10}",
       [
	     (call_script, "script_get_cannon_count", "p_main_party"),
		 (val_add, reg2, 1),
		 (party_set_slot, "p_main_party",slot_party_cannons_3lb, reg2),
	  ...
	  [
       ...
       "Recruit six pound cannon. Cost: {reg11}",
       [
	     (call_script, "script_get_cannon_count", "p_main_party"),
		 (val_add, reg3, 1),
		 (party_set_slot, "p_main_party",slot_party_cannons_6lb, reg3),
	  ...
	  [
       ...
       "Recruit twelve pound cannon. Cost: {reg12}",
       [
	     (call_script, "script_get_cannon_count", "p_main_party"),
		 (val_add, reg4, 1),
		 (party_set_slot, "p_main_party",slot_party_cannons_12lb, reg4),
	  ...
	  [
		(call_script, "script_get_cannon_count", "p_main_party"),
		(gt, reg2, 0),
	  ],"Disband three pound cannon crew.",
       [
          (call_script, "script_get_cannon_count", "p_main_party"),
		  (val_sub, reg2, 1),
		  (party_set_slot, "p_main_party", slot_party_cannons_3lb, reg2),
	  ...
	  [
		(call_script, "script_get_cannon_count", "p_main_party"),
		(gt, reg4, 0),
	  ],"Disband twelve pound cannon crew.",
       [
         (call_script, "script_get_cannon_count", "p_main_party"),
		 (val_sub, reg4, 1),
		 (party_set_slot, "p_main_party", slot_party_cannons_12lb, reg4),
    ...
    (
    "regiment_recruitment",0,
    "This does not work",
    "none",
    [
	  #(troop_get_slot, ":reg", "trp_player", slot_regiment),
	],
    [
      ("new_infatry",
	  [
      ...
      "Form a new infantry regiment. Cost: {reg1}",
      [
	    #(assign, ":price", reg1),
		(troop_remove_gold,"trp_player",reg1),
		(faction_get_slot, ":new_regiment", "$players_kingdom", slot_faction_inf_reg),
		(str_store_party_name, s0, ":new_regiment"),
		(call_script, "script_spawn_new_regiment", ":new_regiment", "$players_kingdom", "trp_player", "$current_town"),
      ]),
      ...
      "Form a new cavalry regiment. Cost: {reg2}",
      [
	    #(assign, ":price", reg2),
		(troop_remove_gold,"trp_player",reg2),
	    (faction_get_slot, ":new_regiment", "$players_kingdom", slot_faction_cav_reg),
		(str_store_party_name, s0, ":new_regiment"),
		(call_script, "script_spawn_new_regiment", ":new_regiment", "$players_kingdom", "trp_player", "$current_town"),
	  ]),
      ...
      # ("new_militia_inf",
	  # [
		# (this_or_next|is_between, "$players_kingdom", kingdoms_begin, kingdoms_end),
		# (is_between, "$players_kingdom", kingdoms_begin, kingdoms_end),
		
	  # ],
      # "Recruit militia regiment {reg3}",
      # [
      ...
      "Recruit troops from regiment reserves",
      [
	    (troop_get_slot, ":reg", "trp_player", slot_regiment),
		(set_mercenary_source_party, ":reg"),
		(change_screen_map),
	...
	(
    "regiment_information",0,
    "Regiment name: {s1}^Regiment based in: {s2}^Regiment men number {reg5} out of {reg6}^Cannon count^3lb cannons: {reg2}^6lb cannons: {reg3}^12lb cannons: {reg4}",
    "none",
    [
	  (troop_get_slot, ":reg", "trp_player", slot_regiment),
	  ...
	  (try_begin),
	    (gt, ":reg", 0),
		(party_get_slot, reg6, ":reg", slot_base_regiment_size),
		(party_get_slot, ":hq", ":reg", slot_hq),
		(str_store_party_name, s1, ":reg"),
		(str_store_party_name, s2, ":hq"),
		(assign, reg5, 0),
	  (try_end),
	  (party_get_slot, reg2, "p_main_party", slot_party_cannons_3lb),
	  (party_get_slot, reg3, "p_main_party", slot_party_cannons_6lb),
	  (party_get_slot, reg4, "p_main_party", slot_party_cannons_12lb),
	],
    [		
      ("disband_reg",
	  [
      ...
      "Disband current regiment",
      [
	    (troop_get_slot, ":reg", "trp_player", slot_regiment),
		(remove_party, ":reg"),
		(troop_set_slot,"trp_player", slot_regiment, 0),
	  ]),
