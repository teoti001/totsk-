...
#  ("relation_plus_90",  "                   Devoted"),
  ...
  ("acres_grain",       "acres of grain and rye"),
  ("acres_corn",        "acres of cornfields"),
  ("acres_orchard",     "acres of orchards and vineyards"),
  ("acres_oasis",       "acres of irrigated oasis gardens"),
  ("acres_olives",      "acres of olive trees"),
  ("acres_gourds",      "fields of gourds"),
  ("acres_hemp",        "acres of hemp"),
  ...
  ("gunpowder",    "gunpowder chemist"),
  ("tea_importer", "tea importers"),
  ("dog_trainer",  "game dog kennels and trainers"),
...
# meet_spy_in_enemy_town quest secret sentences
  ("secret_sign_1",  "Ipsa Scientia Potestas Est..."),
  ("secret_sign_2",  "Wouldst thou know the hour of the play?"),
  ("secret_sign_3",  "Say, old friend, have your heard the new piece by Lully?"),
  ("secret_sign_4",  "I am in search of the best pheasant pies this town has to offer, know you of any?"),

  ("countersign_1",  "Ah, a reader of the fine Sir Francis Bacon, eh, my friend?"),
  ("countersign_2",  "I would appear as though you are late, as it is already underway."),
  ("countersign_3",  "I have, though I must say I care more for this up and coming German fellow named Bach."),
  ("countersign_4",  "Why, yes...just this way, {sir/madame}"),
...
# Surname
  ("surname_1",  "{s50} of Paris"),
  ("surname_2",  "{s50} of London"),
  ("surname_3",  "{s50} of Denmark"),
  ("surname_4",  "{s50} of Austria"),
  ("surname_5",  "{s50} of Bavaria"),
  ("surname_6",  "{s50} of Munich"),
  ("surname_7",  "{s50} of Batavia"),
  ("surname_8",  "{s50} of Dublin"),
  ("surname_9",  "{s50} of Prussia"),
  ("surname_10", "{s50} of Lyons"),
  ("surname_11", "{s50} of Hannover"),
  ("surname_12", "{s50} of Lubjana"),
  ("surname_13", "{s50} of Cartegena"),
  ("surname_14", "{s50} of Moscow"),
  ("surname_15", "{s50} of Bavaria"),
  ("surname_16", "{s50} of Zaragosa"),
  ("surname_17", "{s50} of Toledo"),
  ("surname_18", "{s50} of Caen"),
  ("surname_19", "{s50} of Zurich"),
  ("surname_20", "{s50} of Bourdeaux"),
  ("surname_21", "{s50} the Pirate"),
  ("surname_22", "{s50} the Scarred"),
  ("surname_23", "{s50} the Killer"),
  ("surname_24", "{s50} of Jamestown"),
  ("surname_25", "{s50} of Lisbon"),
  ("surname_26", "{s50} the Bandit"),
  ("surname_27", "{s50} of Madrid"),
  ("surname_28", "{s50} the Grim"),
  ("surname_29", "{s50} of Budapest"),
  ("surname_30", "{s50} from Milan"),
  ("surname_31", "{s50} the Tall"),
  ("surname_32", "{s50} the One Eye"),
  ("surname_33", "{s50} the Fearless"),
  ("surname_34", "{s50} of Palermo"),
  ("surname_35", "{s50} the Cunning"),
  ("surname_36", "{s50} of Palma"),
  ("surname_37", "{s50} of Reims"),
  ("surname_38", "{s50} of Stuttgart"),
  ("surname_39", "{s50} of Frankfurt"),
  ("surname_40", "{s50} of Linz"),
  ("surname_41", "{s50} of Genoa"),
...
# Quest log texts
  ...
  ("banner_selection_text", "As a noble and commander, you are now able to receive a regimental standard.\
  Your standard will signify your status and bring you honour. Which standard do you want to choose?"),
...
#NPC strings
#npc1 = Juraj Janosik
#npc2 = Jacob van Hoornbeek
#npc3 = Moliere Petain
#npc4 = Antonio Luis de San Marie
#npc5 = Captain Peter Drake
#npc6 = Maximillian Shulte
#npc7 = Yilmaz Basturk
#npc8 = Celeste la Fleur
#npc9 = Cyril Maly
#npc10 = Claes Fristorp
#npc11 = Mrs Christian Davies
#npc12 = Dr. Phineas Maplethorpe
#npc13 = Til Leibnitz
#npc14 = Condi Gabrilduro
#npc15 = Gavril Vyhovsky
#npc16 = Noisette de la Marine
#npc17 = Ramon de Sarria
#npc18 = Lev Fyodorovich Golovin
#npc19 = Yasmin bint Amatullah
  
  ("npc1_intro", "Hello good {sir/madame}, are you by any chance looking for some help?"),
  ("npc2_intro", "Hello. Would you be so kind as to have a cup with me? I'm down to my last five notes and I'd rather not drink alone."),
  ...
  ("npc6_intro", "Gluck auf, mein {Herr/Frau}, how are you on this day?"),
  ("npc7_intro", "Yes? Keep your distance, by the way."),
  ("npc8_intro", "Just what in the hell do you want?"),
  ("npc9_intro", "You there, good {man/woman}, be so kind as to fetch me another drink, eh?"),
  ("npc10_intro", "Greetings there, {Brother/Sister}! Here's to the rise of kings, lords, and ladies!"),
  ("npc11_intro", "Hello {sir/madame}, I take it by your gaze that you have pierced my disguise."),
  ("npc12_intro", "Why...! My word, {sir/madame} you have scared the heavens out of me."),
  ("npc13_intro", "Greetings, traveller. I am Til Leibnitz. No doubt you will have heard of me."),
  ("npc14_intro", "Yes? What is it you wish?"),
  ("npc15_intro", "Pozdrowienia, my friend. What brings you to the tavern? Just a drink to pass the time? Come, have a drink on me. You look like an interesting {lad/lass},"),
  ...
  ("npc17_intro", "Buenos dias, mi amigo. I don't think I have seen you in here before. I am about to leave, but would you like to share in the remainder of my Madeira wine?"),
  ("npc18_intro", "Hello there. From the look of you, I'd say you're expecting to get into some fights in the near future. Are you by any chance looking for some help?"),
  ("npc19_intro", "Hello there. From the look of you, I'd say you're expecting to get into some fights in the near future. Are you by any chance looking for some help?"),

  ("npc1_intro_response_1", "I could be, but who are you, young boy?"),
  ("npc2_intro_response_1", "Your last five notes? What happened to you?"),
  ("npc3_intro_response_1", "Hello. What's a clearly well-brought up young man like you doing in a place like this?"),
  ...
  ("npc6_intro_response_1", "The day greets me well. Yourself?"),
  ("npc7_intro_response_1", "My apologies. I was merely going to say that you look a bit down on your luck."),
  ("npc8_intro_response_1", "My apologies, madame. You seem like an interesting person."),
  ("npc9_intro_response_1", "You must have me confused with the tavernkeep, sir."),
  ("npc10_intro_response_1", "Why do you say that, sir?"),
  ("npc11_intro_response_1", "I have, but I'll listen to what you have to say."),
  ("npc12_intro_response_1", "Sorry there, chap. My apologies. What's your story?"),
  ...
  ("npc15_intro_response_1", "Well, sir, if you are buying, I shant turn it down."),
  ("npc16_intro_response_1", "I could be. What's your story?"),
  ("npc17_intro_response_1", "I love Madeira. What brings you to here?"),
  ("npc18_intro_response_1", "I could be. What's your story?"),
  ("npc19_intro_response_1", "I could be. What's your story?"),

  ("npc1_intro_response_2", "I don't need help from children."),
  ("npc2_intro_response_2", "I have better things to do."),
  ("npc3_intro_response_2", "Run along now, sir. I have work to do."),
  ("npc4_intro_response_2", "Eh? No thanks, we don't want any."),
  ("npc5_intro_response_2", "I have no time for that."),
  ("npc6_intro_response_2", "Quite well, though I must be going."),
  ...
  ("npc10_intro_response_2", "That's monarchist talk, and I'll hear none of it. Good day to you."),
  ("npc11_intro_response_2", "Hahaha! Not the best disquise. I'll move on."),
  ("npc12_intro_response_2", "No need to shout, old boy. I depart."),
  ...
  ("npc15_intro_response_2", "Your generosity is appreciated, but no thank you, sir."),
  ("npc16_intro_response_2", "Mind your own business, lass."),
  ("npc17_intro_response_2", "Keep your poison to yourself, peasant."),
  ("npc18_intro_response_2", "Mind your own business, lass."),
  ("npc19_intro_response_2", "Mind your own business, lass."),

#backstory intro
  ("npc1_backstory_a", "I am Juraj Janosik, born in Terchova and baptized in Varin. I may be young, but I am eager to see some battles."),
  ...
  ("npc5_backstory_a", "I am Captain Peter Drake of Ireland and a soldier of fortune or a rascal depending on who tells you of me.."),
  ("npc6_backstory_a", "I am well. Spending some time warming myself in the tavern. The years have not been kind to these bones, and I find I am quick to have an onset of the chills. The local cider seems agreeable in helping this situation."),
  ("npc7_backstory_a", "My luck? You could say that."),
  ("npc8_backstory_a", "So I have heard. I've had a few stumbles along the way. I am the daughter of a French noble, but as I did not care for his nonsense, I left. I have grown something of a thick skin in life, so I apologise for my earlier beahviour."),
  ...
  ("npc11_backstory_a", "It's true I be a lady but please don't give me away! You see I joined the army to find my husband Christian. Have you seen him?"),
  ("npc12_backstory_a", "I am Dr. Phineas Maplethorpe. Of...London. I will have you know I was trained by the most qualified physicians her majesty has. A recent...misunderstanding, you see, has left me without work. Taverns are not my usual place to wander into, but,...these are desperate times."),
  ("npc13_backstory_a", "You have not? I am a wanted man sir! How can you not have heard?"),
  ("npc14_backstory_a", "Very well. I do not mind. My name is Lazalit."),
  ("npc15_backstory_a", "This lager reminds me of the brewery my father ran before The Deluge. He joined Jan Kazmierez's army during the war around 50 years ago. You see, my father was a Don Cossack, but his wife, my mother, was a Polish Szlachta...a noble. He was torn about it. Sadly, I barely remember the man. He died at Zboriv. He was considered a traior when taken prisoner and killed."),
  ...
  ("npc17_backstory_a", "I am Ramon de Sarria, born in La Vila Joiosa and baptized in Valencia. My journey is one of refuge and justice. With Philip V sitting on the throne, many of us are against his support of old noble 'rights' and privileges. I am looking to join up with a militia or regiment going against the Bourbons and those...Botilers."),
  ("npc18_backstory_a", "Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc19_backstory_a", "Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),

#backstory main body
  ("npc1_backstory_b", "My father taught me how to use our family's rapier and I think my skills in that are good. I look about and see Hungarians are revolting against Austrian rule. They have right to do that, because they fight for freedom. They repress us just simply for not speaking their language."),
  ("npc2_backstory_b", "A while back, I was a student at University in Amsterdam. However I became a passionate Republican and began to attend meetings of students who do not want a monarchy to return to the Netherlands. But jealous younger brother told our wealthy father of my activities and he, being a staunch monarchist, has cast me out. I have no home sir, no money to support my way in this life, no hope, and no future."),
  ("npc3_backstory_b", "My family were prosperous merchants in Lyon. For over 300 years we've sold fine French wines from the Lyon region to the English, Germans, Swedes and many other nations. However we were also Protestants. Louis the King of France despises our faith sir. In 1685 he revoked the crowns toleration of our faith and sent his troops to persecute us. My family fled to Koln and my father and older brother went to Holland to join the protestant armies of William of Orange. They died fighting in his sacred cause. I seek my own revenge on Louis XIV."),
  ...
  ("npc5_backstory_b", "I've always had an eye for action sir and an even bigger eye for money. I've joined or will join any army that pays me well enough and gives me wine and wenches enough for me pleasure. I don't care for your causes, your kings, or your religions but I do like your lovely money, the sound of my sabre crushing a man's skull, and the taste of wine from an enormous bosom after the fightings through!"),
  ("npc6_backstory_b", "I once served with the Emperor's Hussars some years back in the Great Ottoman Wars. Sad to think we shed so much blood to save Europe, only to turn upon each other in this coming conflict. I've been in enough cavalry charges to have had my fill."),
  ("npc7_backstory_b", "It was my bad luck to be born to a weak father who sold me off to a Janissary Captain who beat me. It was my bad luck, when I ran away from my Orta, to be taken by a group of bandits. It was my bad luck that the only one among them who was kind to me, who taught me to hunt and to fight, inspired the jealousy of the others, who knifed him and forced me to run away again."),
  ("npc8_backstory_b", "I was educated by my father's tutors and while most girls followed their mother, I guess you could say I picked up some things of my father. I love a good fistight, a good time, good fellowship, fencing, and hunting."),
  ...
  ("npc10_backstory_b", "A sergeant I was, in the army of our old King William taking many a hard knock in many a tough fight, but he died recently and they put a woman on the throne of England and in my Dutch home they refuse to recognize the young Prince of Orange!They'd rather have an old man like Heinsius and a bunch of bureaucrats and fat merchants lead us to war against the great French army! It's a preposterous state of affirs sir!"),
  ("npc11_backstory_b", "He was always in his cups sir. Oh he was a terrible fool when drunk and the squaddies got him drinkin' one night in a tavern and next morning he was marchin' with the regulars for the ships at Plymouth! I've looked all over for him sir but ain't never found him!"),
  ("npc12_backstory_b", "Well...the problem was a most well-connected fellow did fall dead under my hands, but I swear it was not my fault. He was already of choleric disposition and I did my very best, you see, to help the man and his malady."),
  ("npc13_backstory_b", "I am a soldier by profession. A Bavarian who served his elector well enough until recently. I am torn sir for I owed him my service and my rank as an officer and yet I have betrayed him! Yet sir he has betrayed Bavaria and the alliegence he owed the emperor! This alliance with France, with that Bourbon monstrosity, against our sacred Holy Roman Empire is an affront to our honor and our greatest traditions! I could not abide it and I attempted to kill Maximillian for it so great was my shame, as a Bavarian, at his perfidy. However my pistol misfired and I was pursued by his guards until I escaped from Munich."),
  ("npc14_backstory_b", "I am an unfortunate man my good sir. Owing to a disagreement with the Duke of Milan over some small debt I owed him, and the repayment of it, I was cast out of my estate by his men and asked to vacate his Duchy. My wife and children are with a relative whilst I have been forced to seek employment as a humble condottiere. Until recently I was employed training the garrison of this town. Unfortunately, the lord here in {s20} has no taste for the disciplinary methods needed to turn rabble into soldiers. I told him it was wiser to flog them now, then bury them later. But he would not listen, and I was told to take my services elsewhere."),
  ("npc15_backstory_b", "I tended my father's brewery when I came of age, but I served for a while with the Tsar's army as an artilleryman. I am no master of the seige, but I have certainly shot down a few fortress walls. Hahahaha! I left the army and began to wander Europe afterwards. This coming war with Spain bothers me. I do not wish to see my homeland suffer as they send troops to help the Grand Alliance."),
  ("npc16_backstory_b", "I grew up in Calais castle as a bonded servant, working alongside my mother in the kitchens. I would amuse myself by hunting mice through the pantries and sculleries. I was so good at it that I put the castle cats out of a job, and eventually the lord realized that I might also be employed to track down bigger game, on certain errands of a type perhaps better left unsaid. Needless to say, I found a number of opportunities to avail myself of trinkets that had formerly belonged to my lord's enemies. So I was able to buy myself out of bondage, and find hire as a free agent. My last job was {s19}in {s20}."),
  ("npc17_backstory_b", "Our own countrymen left us for Philip, hoping to gain power from his victory. Dammed turncoats. My father raised me as a farmer, but I mostly make my living through hunting and selling game. I'm a maulet, hahaha!. You must understand, mi amigo, we are Catalans in Valencia. They repress us just simply for not speaking their language. My own son was beaten for openly speaking against them."),
  ("npc18_backstory_b", "I grew up in Malayurg castle as a bonded servant, working alongside my mother in the kitchens. I would amuse myself by hunting mice through the pantries and sculleries. I was so good at it that I put the castle cats out of a job, and eventually the lord realized that I might also be employed to track down bigger game, on certain errands of a type perhaps better left unsaid. Needless to say, I found a number of opportunities to avail myself of trinkets that had formerly belonged to my lord's enemies. So I was able to buy myself out of bondage, and find hire as a free agent. My last job was {s19}in {s20}."),
  ("npc19_backstory_b", "I grew up in Malayurg castle as a bonded servant, working alongside my mother in the kitchens. I would amuse myself by hunting mice through the pantries and sculleries. I was so good at it that I put the castle cats out of a job, and eventually the lord realized that I might also be employed to track down bigger game, on certain errands of a type perhaps better left unsaid. Needless to say, I found a number of opportunities to avail myself of trinkets that had formerly belonged to my lord's enemies. So I was able to buy myself out of bondage, and find hire as a free agent. My last job was {s19}in {s20}."),
  
  
  
#backstory recruit pitch
  ("npc1_backstory_c", "But if the Austrians win, I'd become a Balkan bandit. I hate the oppresion of rich lords who take money from village folk. I am not a bandit, but I want to right the wrongs! I want their rights and money returned! Will you help me {sir/madame}?."),
  ("npc2_backstory_c", "So here I am, no money and no way home."),
  ("npc3_backstory_c", "I shall join a regiment and fight for my people's right to exist and practice their religion!"),
  ...
  ("npc6_backstory_c", "Have you heard the King of France is actually going to live up to old Leopold's will and place a Bourbon on the throne of Spain? A king, he may be, but Louis XIV is a fool to believe Europe won't raise an army to bring down upon him."),
  ("npc7_backstory_c", "But I do not count myself unlucky, stranger, no more than any other woman of Europe, this fetid backwater, this dungheap among the nations, populated by apes and jackals."),
  ("npc8_backstory_c", "I have an aristorcratic air due to being raised by one, but deep down I am a member of Third Estate and wish one day for France to be free from Louis XIV. My father was a drunk and something of a horse's arse. I left...and drowning myself here in the taverns. I'm broke. Interested in hiring me? I am an excellent shot."),
  ...
  ("npc11_backstory_c", "Meanwhile I've seen a fair bit of the action myself sir. I was with the lads wot stormed the Schellenburg and who stood their ground at Blenheim and I've been wounded too sir! Right in the thigh. Oh it was horrible and the surgeon nearly discovered me sex too!"),
  ("npc12_backstory_c", "As such, well,...no one comes to my practice and my connections have abandoned me due to fear of losing honour in the face of others. Would you be, well, interested in hiring a chap like me to work on your soldiers? I realise my story is offputting at first glance, but I do assure you, I was well trained and while I am not the best at fighting, I do patch men up quite well."),
  ("npc13_backstory_c", "Which reminds me -- somewhere out there in the city is an agent of the elector who has been sent to capture me . I don't suppose you might consider helping me leave town?"),
  ...
  ("npc15_backstory_c", "These days I have no place I call home just yet. You could say I have what the Germans call 'wanderlust,' a need to travel. Maybe it is my nomadic heritage... You seem to have come with the same look in your eyes. Would you be interested in having an old Cossack like me along for your travels?"),
  ...
  ("npc17_backstory_c", "However, if the Bourbons win this coming war, my family and countrymen would pay a dear cost for it. We are tired of their extortion and we seek nothing but justice and freedom. Trust me, {sir/madame}, when I claim to be no bandito. All I ask is for a change to prove myself against the enemies of Catalonia. Are you such a person, {sir/madame}?"),
  ("npc18_backstory_c", "Unfortunately, my last employer's wife had a lovely amulet, of a kind I simply could not resist. She doesn't know it's missing, yet, but she might soon. So tell me, are you looking for helpers?"),
  ("npc19_backstory_c", "Unfortunately, my last employer's wife had a lovely amulet, of a kind I simply could not resist. She doesn't know it's missing, yet, but she might soon. So tell me, are you looking for helpers?"),


### use these if there is a short period of time between the last meeting
  ("npc1_backstory_later", "I've been still here since your last visit {sir/madame}. I was helping local merchants for few bank notes. But this way of living is not for me! I can see the poverty and oppresion everywhere."),
  ("npc2_backstory_later", "I sold my boots and have managed to make a few notes peddling my old university books from town to town, but it's a hard living."),
  ("npc3_backstory_later", "I hired myself on as a cook for some passing caravans, and that at least keeps me fed. But it is rough company on the road, and I grow weary of fighting off cut purses and others who would try to take my liberty. I was thinking that if I could find work as a soldier, men would know this is a protestant to be feared."),
  ...
  ("npc5_backstory_later", "I've been wandering through this war-torn land, looking for a leader who is worth following and who pays handsomely."),
  ("npc6_backstory_later", "I have been mending my garden and traveling Europe."),
  ("npc7_backstory_later", "I have been wandering, looking for work as a tracker, but it has not been easy. Europeans are mostly ill-bred, lice-ridden, and ignorant, and it is not easy to work with such people."),
  ("npc8_backstory_later", "In search of meaning in my life."),
  ...
  ("npc10_backstory_later", "I don't know if I told you or not, but I deserted my unit after I struck a young officer who had ordered me to be horsewhipped for speaking out for monarchy. Since then I've been laying low. Thankfully I had the wit to pilfer my captain's purse before heading out, but the money is running low."),
  ("npc11_backstory_later", "I've been around and about trying to find my Christian. Dear, I hope he's alive."),
  ("npc12_backstory_later", "Gah! My goodness, {playername}. You seem to have a knack for sneaking up on a man."),
  ("npc13_backstory_later", "I have been wandering through the cities of Europe, and always my pursuers are at my heels. But I grow weary of their chase and perhaps the safety of many brothers in arms to shield me will turn aside my would be captors."),
  ("npc14_backstory_later", "I have gone from court to court, but I have not yet found a lord who is to my liking."),
  ("npc15_backstory_later", "I am a wanderer! Hahaha! I have seen many places in Europe. The beautiful Alps, the Bavarian Biergaten, and some beautiful country sides. This land is a treasure."),
  ...
  ("npc17_backstory_later", "Ah, {playername}! As I said, I still yet search for a commander to give me the chance to fight the Bourbons."),
  ("npc18_backstory_later", "I do the odd job from time to time. But there's naught like steady employment, and a regular run of corpses to loot."),
  ("npc19_backstory_later", "I do the odd job from time to time. But there's naught like steady employment, and a regular run of corpses to loot."),


  ("npc1_backstory_response_1", "I could offer you place in my company."),
  ...
  ("npc6_backstory_response_1", "You know, you could turn your plowshare back into a sword, join me, and help me stop this madness..."),
  ...
  ("npc11_backstory_response_1", "I'm sure I'll be doing a lot of traveling. Why don't you join us?"),
  ("npc12_backstory_response_1", "I'm willing to overlook your mishap and give you another chance, but be aware I expect all my regimentals to fight in the line. There are no exceptions."),
  ...
  ("npc15_backstory_response_1", "No place to call home? I fully understand, sir. Bring your horse around and join me."),
  ("npc16_backstory_response_1", "I might be. What can you do?"),
  ("npc17_backstory_response_1", "Mayhaps I can offer you such a chance. How good are you with a musket?"),
  ("npc18_backstory_response_1", "I might be. What can you do?"),
  ("npc19_backstory_response_1", "I might be. What can you do?"),

  ("npc1_backstory_response_2", "I would rather spend my money on some battle-hardened soldiers, boy."),
  ("npc2_backstory_response_2", "Hard luck, friend. Good day to you."),
  ("npc3_backstory_response_2", "Go back to your family, son. War is no place for so pious a sot whose bent on holy revenge."),
  ("npc4_backstory_response_2", "No, sorry, I haven't heard of one."),
  ("npc5_backstory_response_2", "I'll have no truck with rascals like yourself sir who are likely to take my wages and depart before the battle has even begun."),
  ("npc6_backstory_response_2", "Well, good luck in your travels, sir!"),
  ("npc7_backstory_response_2", "Actually, I'm rather fond of the place. Good day to you."),
  ("npc8_backstory_response_2", "Sorry, you are a bit too 'rough' for me, m'dear."),
  ...
  ("npc11_backstory_response_2", "I am sorry to hear of your...situation. Good day."),
  ("npc12_backstory_response_2", "Hahaha! Sorry, I shall be upon my way."),
  ...
  ("npc17_backstory_response_2", "I must say, that's quite a tale. I don't hire peasants, I hire soldiers."),
  ("npc18_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),
  ("npc19_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),

  ("npc1_signup", "Could you? I would be pleased to join you. Nearly everything I own is with me."),
  ("npc2_signup", "Well, I will confess that I am not a soldier by trade."),
  ...
  ("npc6_signup", "Maybe. I am old, but...my experience might help you. You seem like a {man/woman} genuinely interested in righting the world."),
  ("npc7_signup", "I might be. I could certainly use the money."),
  ("npc8_signup", "I might appear rough, but...I have a heart of gold for those who can put up with it. I won't let you down. Though I do have some expenses to take care of before I leave."),
  ...
  ("npc11_signup", "If ya were ta hire me I swear I can drill your lot well as I know a fair bit about firing a musket and pistol sir and I am a good hand with a bayonet too! I fight just as hard as any man, I assure you that, good {sir/madame}."),
  ("npc12_signup", "Well, I have cracked a few skulls in my day and I do own a very fine musket given to me by one of the Duke of Marlburough's men."),
  ...
  ("npc15_signup", "...and I shall! However, I must ask a small favour of you. I have rented a room here and owe the innkeeper 400 notes for my stay. Would you mind covering it?"),
  ...
  ("npc17_signup", "I am a dammed fine shot, {sir,madame}. Get me in front of that Bourbon flag, and I can assure you I will pip the ace when told. "),
  ("npc18_signup", "Well, {sir/madame}, let me tell you. I may not know how to read and write, but I know the quickest way to a man's heart is between his fourth and fifth rib, if you understand me. "),
  ("npc19_signup", "Well, {sir/madame}, let me tell you. I may not know how to read and write, but I know the quickest way to a man's heart is between his fourth and fifth rib, if you understand me. "),
  

  ("npc1_signup_2", "I learn quickly and will serve under your regiment as I want to help free my people from oppresion!"),
  ("npc2_signup_2", "I'm a fast learner. I can ride, and know a fair bit about trade, prices and such."),
  ("npc3_signup_2", "I think you would find I would be a most valuable addition to your ranks. I am well versed in the classics of literature and can declaim several of the epic poems of my people. I play the harpsichord and am a skilled manager of household servants."),
  ...
  ("npc5_signup_2", "I shall not betray you -- so long, of course, as you do your duty to me by feeding me, paying me, and not dragging my miserable hide into a battle where there is no chance of winning. Hand me some coins, if you will -- it is my custom to take a wench upon the agreement of a new enlistment."),
  ("npc6_signup_2", "I might be a bit slower than some of your other men, but...I could probably do the job. I will admit a fondness that remains wistful for the days of gallantry upon the field of battle."),
  ...
  ("npc8_signup_2", "I would be honoured if you would pay my way. I am an excellent markswoman and you'd search antiquity for a woman who could take on men."),
  ...
  ("npc10_signup_2", "You won't regret taking me on, {Brother/Sister}. I'm a dead eye with a musket -- a beautiful weapon, it can right punch through a currassier's armour and spill his blood upon the ground. And I've trained many a raw recruit since 1690 to line up in good order and stand a volley from a furious foe."),
  ("npc11_signup_2", "I do a wee bit of cooking, as well. I wasn't always like this. Before this terrible war I was just a regular Irish woman. Would you really take me on? I'd much appreciate it."),
  ("npc12_signup_2", "Also, allow me to assure you that this whole business with me being...well...unemployed, truly is a misunderstanding. My surgical skills are top notch, and I am confident of my abilities."),
  ("npc13_signup_2", "Sword,and musket I pledge to thee my captain and may you prove a more honest and worthy master than my last one."),
  ...
  ("npc17_signup_2", "I also have my hunting sword, a cartouche of cartridges, and a determined heart. Having to hit a fox on the run with shot is not a skill one picks up quickly...and I have it."),
  ("npc18_signup_2", "I can throw knives, in addition to stabbing with them, and I'm slippery as quicksilver. You'll find me useful in a fight, I'll warrant."),
  ("npc19_signup_2", "I can throw knives, in addition to stabbing with them, and I'm slippery as quicksilver. You'll find me useful in a fight, I'll warrant."),
  ...
  ("npc5_signup_response_1", "Certainly. Here, have some coins."),
  ("npc6_signup_response_1", "Sir, your words honour me. Come, I will pay well and assure you good company."),
  ("npc7_signup_response_1", "I will hire you. Try not to shoot anyone on your first day."),
  ("npc8_signup_response_1", "Hahaha! Well, welcome aboard, my dear Celeste."),
  ...
  ("npc12_signup_response_1", "Then welcome to our regiment, doctor"),
  ...
  ("npc15_signup_response_1", "Quite a sum for a small favour, but I will do so gladly."),
  ("npc16_signup_response_1", "It sounds like you can do the job. I will hire you."),
  ("npc17_signup_response_1", "Haha! Welcome to the regiment. Grab your equipment."),
  ("npc18_signup_response_1", "It sounds like you can do the job. I will hire you."),
  ("npc19_signup_response_1", "It sounds like you can do the job. I will hire you."),

#11
  ("npc1_signup_response_2", "I'd rather not risk being called an outlaw. Good bye!"),
  ...
  ("npc6_signup_response_2", "On second thought, maybe being in another war is not what you need right now."),
  ("npc7_signup_response_2", "Actually, on second thought, you sound like you might be trouble. Good day to you. "),
  ("npc8_signup_response_2", "Truly, you are an odd person. I shall see you another day, perhaps."),
  ...
  ("npc12_signup_response_2", "One's ability to use a knife doesn't promise ability on the field. Sorry, I will be on my way."),
  ("npc13_signup_response_2", "Actually, on second thought, a fighter with so many powerful enemies is dangerous to have in one's company."),
  ("npc14_signup_response_2", "Actually, I have no wish to provoke a mutiny in my ranks. Good day, sir."),
  ("npc15_signup_response_2", "Sir, I am not your money lender. Good day."),
  ("npc16_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),
  ("npc17_signup_response_2", "You seem a touch...bloodthirtsy for our tastes. Thanks for the wine. Good day, sir."),
  ("npc18_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),
  ("npc19_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),

  ("npc1_payment", "{!}."),
  ("npc2_payment", "{!}."),
  ("npc3_payment", "{!}."),
  ("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} notes? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."),
  ("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} notes? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."),
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} notes from you. It's an advice my father gave me. He told me 'Peter, never fight for a toff before {he/she} pays you your worth of gold first'."),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} notes first. You aren't expecting me to work for free, do you?"),
  ("npc8_payment", "Allow me to grab my gear and I shall head towards your encampment. Again, though, I would require {reg3} banke notes. I will gladly share in any bounty or harvest later, but I assure you it is a small cost for my worth."),
  ("npc9_payment", "That's very good of you. And before I join, can you lend me {reg3} notes, so that I can buy some proper clothing that befits a gentleman of noble birth such as myself. The coat on me has been worn down badly due to my recent bad fortune, and I cannot let common soldiers mistake me as one of their own."),
  ("npc10_payment", "That's good news. But I'll ask for one last thing, captain. I have a woman here in {s20}, a tavern wench, and she says she has my child in her belly. I want to give her some money before I leave... for the child, you know. Do you think you can spare {reg3} notes?"),
  ("npc11_payment", "There is, uh, one little problem. See, if I just run off, they'll catch for desertion and find me out. So, do you mind paying out me contract of {reg3} banke notes? It's not much, but I can't afford it on me wage."),
  ("npc12_payment", "{!}."),
  ("npc13_payment", "Before I sign up, there is the small matter of some expenses I have incurred while staying here -- {reg3} notes. Do you think that you could cover those for me, as a gesture of friendship?"),
  ("npc14_payment", "Ah, one last thing. I would ask for an initial bounty of {reg3} notes before I join your command. It's my principle never to enter someone's service without receiving the payment I deserve."),
  ("npc15_payment", "Hahaha! Well, I can assure you I will cost little from here on out. Plus, your men look like they could use a proper education in seiges and engineering. I shall follow your lead."),
  ...
  ("npc17_payment", "{!}. "),
  ("npc18_payment", "Now, that's good news, captain. So, how about paying me a little something to seal off our agreement? A mere {reg3} would be enough. Please don't take this the wrong way, but I've had some bad luck with employers in the past. "),
  ("npc19_payment", "Now, that's good news, captain. So, how about paying me a little something to seal off our agreement? A mere {reg3} would be enough. Please don't take this the wrong way, but I've had some bad luck with employers in the past. "),

  ("npc1_payment_response", "{!}."),
  ("npc2_payment_response", "{!}."),
  ("npc3_payment_response", "{!}."),
  ("npc4_payment_response", "Certainly. Here's {reg3} notes."),
  ("npc5_payment_response", "Well... here's {reg3} notes, then. Your first payment."),
  ("npc6_payment_response", "{!}."),
  ("npc7_payment_response", "No, of course not. Here's {reg3} notes."),
  ("npc8_payment_response", "That will not be a matter at all. Here's {reg3} bank notes."),
  ("npc9_payment_response", "Very well, here's {reg3} notes."),
  ("npc10_payment_response", "Of course. Here, {reg3} notes."),
  ("npc11_payment_response", "Very well, here's {reg3} bank notes. Make yourself ready. We leave soon and we're encamped outside the city."),
  ("npc12_payment_response", "{!}."),
  ("npc13_payment_response", "Of course, here's {reg3} notes. Make ready to leave soon."),
  ("npc14_payment_response", "All right, here's {reg3} notes. You are most welcome in our company."),
  ("npc15_payment_response", "Meet us around back, and here are your notes. Glad to have you with us, Gavril."),
  ("npc16_payment_response", "All right, here's {reg3} notes for you. Make yourself ready."),
  ("npc17_payment_response", "{!}."),
  ("npc18_payment_response", "All right, here's {reg3} notes for you. Make yourself ready."),
  ("npc19_payment_response", "All right, here's {reg3} notes for you. Make yourself ready."),




  ("npc1_morality_speech", "I joined with you to right wrongs, protect the innocent, not {s21}, Captain. Take a little more care in the future, if you don't mind my saying."),
  ...
  ("npc13_morality_speech", "Captain, if we can avoid it, I'd prefer not to {s21}. Europe is a small place, and one's reputation is precious. I would not care for one of my rivals to include this latest unfortunate incident in a satirical verse."),
  ("npc14_morality_speech", "I do not care to {s21}. No one with a reputation for cowardice will be properly feared by his men."),
  ("npc15_morality_speech", "{Sir/Madame}, I would rather we not engage in {s21}. If we must part ways over it, I'll have no qualms."),
  ("npc16_morality_speech", "Captain. I don't like to {s21}. So many throats left uncut, and so many purses left unexplored..."),
  ("npc17_morality_speech", "Captain. I am not interested in {s21}. I enlisted with you to stop injustices, not commit them. I demand we cease this activity."),
  ("npc18_morality_speech", "Captain. I don't like to {s21}. So many throats left uncut, and so many purses left unexplored..."),
  ("npc19_morality_speech", "Captain. I don't like to {s21}. So many throats left uncut, and so many purses left unexplored..."),
  


  ("npc1_2ary_morality_speech", "Pardon me Captain, but I don't think it was right deccision to {s21}."),
  ...
  ("npc15_2ary_morality_speech", "Captain, a {man's/woman's} honour in this world goes fathoms. You should not {s21}. However, I must admit I would have done the same."),
  ...
  ("npc17_2ary_morality_speech", "Captain, fulfilling debts and upholding honour is all one has in life. Doing {s21} leads us down the path of the Botifler: thieves, liars, and brigands."),
  ("npc18_2ary_morality_speech", "{!}[No secondary moral code]"),
  ("npc19_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),

  ("npc1_personalityclash_speech", "Captain -- no offense, but I'm a bit tired of {s11}, who thinks she's something better than your humble servant Juraj."),
  ...
  ("npc15_personalityclash_speech", "Sir, I feel I must address my quarel with {s11}. She is not a woman of honour, and would get us all killed in a battle"),
  ...
  ("npc17_personalityclash_speech", "Captain, {s11} is a Bourbon supporter. He seeks to put that usurper Philip V on the throne. Mark me words, {playername}, if you do not discharge him, I shall make sure he does not wake to see the sun."),
  ("npc18_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
  ("npc19_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
  

  ("npc1_personalityclash_speech_b", "She thinks she is something better than me when I am from a humble village. I find her demeanour less than tolerable and I would never want to meet her."),
  ...
  ("npc15_personalityclash_speech_b", "She's threatened to stab me in my sleep for complaining of her lack of discipline. I feel we should dischage her before she gets any more of our soldiers killed."),
  ...
  ("npc17_personalityclash_speech_b", "I attempted to reason with him through discussion, but he threatened me with a pistol and called me a filthy peasant. Men such as himself will be hanged by such words."),
  ("npc18_personalityclash_speech_b", "Fearing witchcraft, I asked him about it, and he told me that a chit of a girl like myself should mind her own business. So I had a look in his baggage, and found strange plans and diagrams. I think he's a sorceror, {sir/madame}, and if I catch him trying to hex me he'll have a knife in his throat."),
...
### set off by behavior after victorious battle
  ("npc1_personalityclash2_speech", "Captain, I may not be some great strategos, but I don't particularly like how {s11} acted cowardly, back there."),
  ...
  ("npc17_personalityclash2_speech", "Commander, have you actually listened to {s11}? The man is no better than de San Marie. I can overhear him telling the men at night about his plans to bring the monarchy back to the United Provinces. I suggest we leave him."),
  ("npc18_personalityclash2_speech", "Beg your pardon, {sir/ma'am}. {s11} might have been a very good thief, but he's not got the stomach to be a warrior, if you ask me."),
  ("npc19_personalityclash2_speech", "Beg your pardon, {sir/ma'am}. {s11} might have been a very good thief, but he's not got the stomach to be a warrior, if you ask me."),
  ...
  ("npc17_personalityclash2_speech_b", "I'm convinced if he were to be my second, I would die by his musket rather than our foes. I do not trust that man."), #klethi - borcha
  ("npc18_personalityclash2_speech_b", "After our last scrap, I was slicing open the guts of some our foes to check for hidden gold, as a girl who counts her pennies ought. He gagged and muttered that I was an 'animal.' I'll inspect his innards for contraband if he doesn't keep a civil tongue in his head."), #klethi - borcha
  ("npc19_personalityclash2_speech_b", "After our last scrap, I was slicing open the guts of some our foes to check for hidden gold, as a girl who counts her pennies ought. He gagged and muttered that I was an 'animal.' I'll inspect his innards for contraband if he doesn't keep a civil tongue in his head."), #klethi - borcha
  ...
  ("npc6_personalitymatch_speech", "Captain. Sometimes I am troubled by all this bloodshed, although I know that proud warlords must be humbled, and cruel bandits tamed, if we are to restore peace to Europe."),
  ...
  ("npc17_personalitymatch_speech", "Commander, I wish to express my admiration for {s11}. Her desire to leave the nobility and help the peasants in France warms my heart."),
  ("npc18_personalitymatch_speech", "Oy -- captain. I was just having a chat with {s11}, as we picked through the bodies after our last little scrap."),
  ("npc19_personalitymatch_speech", "Oy -- captain. I was just having a chat with {s11}, as we picked through the bodies after our last little scrap."),

  ("npc1_personalitymatch_speech_b", "Without good honest souls like him, people like me would have a hard time in life, I'll warrant. I'm glad to have him with us."),
  ...
  ("npc12_personalitymatch_speech_b", "It saddens him deeply to take the lives of his fellow men, however just the cause. He and I have talked together of a brighter future, of the need to unite these petty warring kingdoms of Europe, so that we may bring this time of troubles to an end."),
  ...
  ("npc17_personalitymatch_speech_b", "She is quite versed in many things and a valiant fighter. Idealistic, but I support her. If she is the calibre of people you enlist, our regiment will be renown forever."),
  ("npc18_personalitymatch_speech_b", "Have you heard her story? Can you believe the wrongs done to her? I tell you, it makes my blood boil. I want to cut off all the little bits of those bastards who mistreated her -- and I'll do it, too, if we ever run into them in our travels."),
  ("npc19_personalitymatch_speech_b", "Have you heard her story? Can you believe the wrongs done to her? I tell you, it makes my blood boil. I want to cut off all the little bits of those bastards who mistreated her -- and I'll do it, too, if we ever run into them in our travels."),


  ("npc1_retirement_speech", "I'm a bit tired of marching up and down somewhere far from my homeland, fighting enemies I have never seen before. The loot is good, but I think I've got enough of that, now. I'm going to head back to my home village and fight for my cause."),
  ...
  ("npc7_retirement_speech", "I am tired of this squalid life of endless warfare, seeing men debased by fear, greed, lust, and a hundred other sins. I have money in my purse. I am going overseas to look for a better land than Europe. I assume that you will fare well without me."),
  ...
  ("npc10_retirement_speech", "I've had enough of tromping up and down the length and breadth of Europe. I've got enough to buy a small bit of land somewhere, so I think I'll give that a try. So long, and best of luck to you."),
  ...
  ("npc12_retirement_speech", "I've done all right in your company. I filled my belly, put some gold in my purse, and broadened my knowledge of wounds and injury -- I can't complain about that! But I think right now that service in this company is holding me back. I have a duty to share my findings with other surgeons, and for that I need to hire scribes, who are rare in Europe. I shall be going home"),
  ...
  ("npc17_retirement_speech", "Commander, we have seen nearly every part of Europe, but I fear I must leave for the time being. Perhaps we shall see each other. I hope you understand."),
  ("npc18_retirement_speech", "I've had good times in this company, and I've found myself a pretty trinket or two on the battlefield, but right now it isn't working out. I'm leaving you to go offer my talents to someone else."),
  ("npc19_retirement_speech", "I've had good times in this company, and I've found myself a pretty trinket or two on the battlefield, but right now it isn't working out. I'm leaving you to go offer my talents to someone else."),

  ("npc1_rehire_speech", "Boss -- it's good to see you again. I know we had our differences in the past, but to tell you the truth, those were some of the best days I've known. And, to tell you the truth, I've had a bit of difficulty finding work. Listen, if you'd be willing to have me back, I'd be willing to sign up with your regiment again."),
  ...
  ("npc7_rehire_speech", "Captain! It is good to see you. Forgive what I may have said when we parted. I took a ship out of Wercheg, bound for the east, but it was taken by pirates and after my ransom I was set ashore back here. There may be better places in the world than Europe, but I have yet to see them. So I think, if it is my lot to live here, then your company is as good a livelihood as any. Will you have me back?"),
  ...
  ("npc14_rehire_speech", "Captain. It is good to see you. When last we parted, I was ready to swear that I would not serve you again, but perhaps I judged you too harshly. All over Europe, men sing your praises. I have tried serving in other lords' armies, and believe me, what I have seen of them restores my opinion of your leadership. If you would have me in your company, I would fight for you again."),
  ...
  ("npc17_rehire_speech", "Ah, {playername}, it's you! It was most unwise of me to leave your regiment. I was nearly arrested by Louis XIV's new police as I attempted to cross the borders into Catalonia. I hear you are still for our cause. We should join forces once again."),
  ("npc18_rehire_speech", "Captain! They say that you've done well for yourself since we last met. I'll come out and admit that I cursed your name when we parted ways, but thinking back on it you weren't all that bad. All these lords, they're glad enough to send me on little side errands, but they don't much care to have me in their main battle-line. Apparently I spook the men. I've heard it muttered that I'm a witch, or that I eat men's hearts after killing them, or other rot. Not that I mind stabbing a man while he's asleep, but it's a lot more gratifying when he's awake and kicking. So I thought I'd try to find you again, see if you'll take me on."),
  ("npc19_rehire_speech", "Captain! They say that you've done well for yourself since we last met. I'll come out and admit that I cursed your name when we parted ways, but thinking back on it you weren't all that bad. All these lords, they're glad enough to send me on little side errands, but they don't much care to have me in their main battle-line. Apparently I spook the men. I've heard it muttered that I'm a witch, or that I eat men's hearts after killing them, or other rot. Not that I mind stabbing a man while he's asleep, but it's a lot more gratifying when he's awake and kicking. So I thought I'd try to find you again, see if you'll take me on."),

#local color strings
  ("npc1_home_intro", "Boss -- did you know that I was born around here, in the high Hungarian plain? This is where I got my eye for horseflesh, because this is good land for horses, although a hard land for men. I suppose that's why the Magyars like it."),
  ("npc2_home_intro", "We're approaching Amsterdam. That's where I was headed when the bandits got me."),
  ("npc3_home_intro", "Can you smell that? Rotting ships, crates and seafood, it's the scent of Cherbourg. I spent many a happy summer here when I was a lad, playing in the gardens of my mother's family while my father was away trading."),
  ("npc4_home_intro", "The Woods of Toledo. Bah. This place is thick with bandits and outlaws."),
  ("npc5_home_intro", "Captain, we are nearing Wexford, largest town in Ireland. My mother's sister went here to marry a townsman and I thought to seek service with the lord here. That is when I ran into you."),
  ...
  ("npc8_home_intro", "Hmf. Do you hear that? It must be the cry of the town guard on the rampart. We must be near the old artillery fort near my home."),
  ("npc9_home_intro", "Behold the walls of Prague! The strongest fortress in Europe. My father was one of those who held the line here against the Turks, when they first tried to push into the empire from the south."),
  ("npc10_home_intro", "D'you smell that fresh air, Brother? This was my home, before I went abroad in search of coin. It's good to be up in the Netherlands again. It's the smell of freedom. This is the cradle of Dutch liberty, here under Nijmegan Castle"),
  ...
  ("npc13_home_intro", "Ah, Castle Frankfurt! Such a lovely spot, at the foot of the German Rhineland. Such happy days I spent here, the summer before last."),
  ("npc14_home_intro", "Do you see that fortress up there, on the spur over the valley? Milan? I spent many a winter there some years back, trying to train the lord's men."),
  ("npc15_home_intro", "You see that castle up on the hill? Khymelnitsky Castle, it's called. I did some work there, not long ago. It's not as showy as some of the other castles in this land, but it's the finest stonework you ever saw."),
  ("npc16_home_intro", "Aye, captain, do you see those? Those are hare tracks in the snow. We must be getting near to my birthplace."),
  ("npc17_home_intro", "...commander. Can you smell that? It's the apple orchards of Valencia. We use them to make our Calvados brandy, the finest in the world!"),
  ("npc18_home_intro", "Aye, captain, do you see those? Those are hare tracks in the snow. We must be getting near to my birthplace."),
  ("npc19_home_intro", "Aye, captain, do you see those? Those are hare tracks in the snow. We must be getting near to my birthplace."),


  ("npc1_home_description", "Well, Magyars always lived here, even back in the old days, as the Emperor gave them gold and lands to keep out the other tribes. I'm told my grandfather was a Magyar chieftain, although my mother didn't know him, any more than I knew my father. When my mother was a lass, the Turks started coming over the mountains in larger numbers, and now there's a Turkish Pasha in Transylvania."),
  ("npc2_home_description", "People say that the Dutch are a bunch of humorless merchants, but they have a good head for trade, if you ask me. They make the people up and down the coast grow flax, which they weave here into linen. It can't compete with Ottoman silks and velvets as a luxury fabric, but it makes good summertime wear and you can use it for the sails of ships. More importantly, linen was one of the few goods that someone else in Europe wasn't already making."),
  ("npc3_home_description", "Cherbourg has wet winters and hot summers, but the people here build great cisterns to water their crops. They grow grapes -- Cherbourg wine is famous, {sir/madame} -- and those who can afford it make walled gardens, where fruit trees grow in abundance, and we sit at night listening to music, or playing chess, or merely sniff the night air."),
  ("npc4_home_description", "Well, you see, the King of Spain declared this to be his personal hunting preserve, and said he'd kill any man who as much as powdered his musket here. So what happens? Some family goes hungry, and succumbs to the temptation to poach, and the king's sheriff comes along and strings him up and takes his land. His sons, rather than starve, go bandit. And so naturally anyone in the whole valley who feels the need to run away from a debt or a nagging wife or a vengeful noble comes up here to join them, living on wild pigs and berries and the purses of unwary travellers."),
  ("npc5_home_description", "Englishmen had always come here, to trade and raid, and in the last days of the Stuarts we began to settle. Just like the Danes, Scots, and so many others, we took the King's coin to keep the Catholic at bay. But when the Catholic's rose and attacked our homeland in my grandfather's day, we moved into this region in force. We pushed the Catholic's back, and made their fortresses our own."),
  ("npc6_home_description", "Here in the Vale of Stuttgart, our dialect and customs are closer than anywhere else in Europe to those of the old Frankish Empire. We grow olives and wine, both crops brought to this land from overseas by the emperors, and also follow the old Frankish ways. We keep our pledges and pay our debts."),
  ("npc7_home_description", "Before I was sold off, and before I was taken by bandits, I lived here. I was born in a hovel and spent my childhood in the fields. Our landlords were Turk, but we never saw them, merely their cursed minions and overseers. My father, coward that he was, cringed before them."),
  ("npc8_home_description", "You haven't heard the story? When Vauban came to Bordeux from Paris, he placed the foundation stone of this fort and drew up it's design. It was one of his first forts and meant to allow French armies to concentrate and turn towards the Rhine."),
  ("npc9_home_description", "The Turks would ride up by the river Danube. The townsmen of the river could have stopped them, but they were cowards then, as they are today, and paid them a yearly stipend, known as the tribute, to be let in peace. But the Austrians would not pay. My father decided to come over the mountains, to fight with the Austrian hosts. Three summers in a row they tried to take the walls, and each time the Austrian lords held them back."),
  ("npc10_home_description", "In my father's day the Spanish would come calling, thinking to make us knuckle our foreheads and call them their overlords. But William, an old veteran of the wars, showed us how to form a battleline with pike and musket that could break a Spanish charge. He fell in battle, but the people gave his name to the castle that was built here, where he fell, so that we would remember, and always stand firm against the horsemens' onslaught."),
  ("npc11_home_description", "I'm from Dublin. You know the saying, {sir/madame} -- 'Barley grown in Dublin is made into ale in London, and we're all the better for it.' Not sure what that means, {sir/madame}, but it's true about the barley. And wheat, and oats. We grow more grain here in Dublin then all the rest of Europe put together, and our ale is the best, too. You can see it in the soil here -- rich and black, and smells of good harvests and full bellies."),
  ("npc12_home_description", "The lord over there in London had the dropsy, and had requested a doctor from London to treat him. Like a typical university-educated doctor, he went right to Paracelsus for a cure. Paracelsus commends sun-metal for dropsy. Now most of Paracelsus's writings were useless back in the days of the Roman emperors when they were first written down, and they're doubly worthless today, but sometimes he hits upon the right cure by chance: sun-metal does cure some kinds of dropsy in small doses. However, sun-metal in large doses is poison, something that the Paracelsus-worshippers never grasped."),
  ("npc13_home_description", "I had come up here with a small Austrian force, but they were caught by the Bavarians in the woods and their horsemen cut down amid the trees. I fled and found shelter up in the high valleys, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tales from the hills -- of playful goat-men who guide lost animals back to their flocks, or of ghostly huntsmen who ride the winds, chasing stormclouds. Such rustics they are!"),
  ("npc14_home_description", "I say 'trying' because in my opinion, Italians don't take well to discipline. Finest swordsmen you ever saw, and good riders too, but they have no stomach for fighting in ranks. Their skills serve them well enough against Arabs and Turks, particularly when they can hide behind walls, but Spanish can match them musket for musket, and I've seen French cavalry cut through Englishmen like a knife through butter. Now, a Dutch pike-wall is designed to stop a French charge in its tracks, and usually does."),
  ("npc15_home_description", "Like most castles that last around here, it's got foundations that are old Polish. You can't see them any more with all the rebuilding, but the slabs are the size of a house. They must have been real sorcerors back in those days, because I don't see how they moved those things otherwise. Beautiful location, too -- Khymelnitsky sits right in front of the pass leading out of Europe, which allows the hetman to charge a pretty penny in tolls during the three months of the year that it's not snowed in."),
  ...
  ("npc17_home_description", "This is what we fight for...these simple pleasures of freedom and life. We do not ask for much in life, but to be free and happy. Just the smell of those orchards reminds me of my wife and my son lost to this war."),
  ("npc18_home_description", "The snows in these valleys don't melt until late in the year, and the land is hard to plough. You can grow a bit of barley, but not much else. But there's wealth here in the woods: deer, rabbit and lynx, meat and furs, and the mountains have iron, and traders would ship enough saltfish up the river from the coast to keep the people fed for the winter."),
  ("npc19_home_description", "The snows in these valleys don't melt until late in the year, and the land is hard to plough. You can grow a bit of barley, but not much else. But there's wealth here in the woods: deer, rabbit and lynx, meat and furs, and the mountains have iron, and traders would ship enough saltfish up the river from the coast to keep the people fed for the winter."),

  ("npc1_home_description_2", "They go easy on us farming folk, and don't ask for much in tax -- not that we would be able to pay in any case. The land isn't good enough for most crops. Frankly, it's only good for horse-rearing, and that only for half of the year, in the winter after the rains. In the summer they take their herds back into the mountains. Caravans come over the hills and bring spice to Buda, but we don't see much of that money down in the villages."),
  ("npc2_home_description_2", "I miss my homeland and my family. But they are too yoked to the old ideas of Europe and they do not yet embrace the coming change."),
  ("npc3_home_description_2", "The poets call Cherbourg a paradise, and I think for once that they do not exaggerate."),
  ...
  ("npc5_home_description_2", "Of course, you know how things go. My father's generation were hard soldiers from the English lands across the sea, but this generation all has houses in the town and great estates and spend time as much trading as they do practicing martial arts. The next generation will grow soft on French wine and will lose their lands to the next batch of illiterate sea-raiders to come over the sea, just you watch. It's how things always were, and how things always will be."),
  ("npc6_home_description_2", "We men of Stuttgart also never forget an insult, and avenge any wrong done unto us. Old-fashioned Germanic honour, I dare say, has brought me to my current fallen state. But despite that, I am proud to be from this region. Our lord is an officer of the French king in Paris, but as far as we are concerned he is just yet another plaything of the French king, and we are the empire's true heirs."),
  ("npc7_home_description_2", "We were allowed to fish the river, raise pigs amid the reedbeds, and grow whatever we could in our private plots, but in the open fields we were only permitted to grow flax, to be taken to Istanbul and woven into linen. So we were always hungry, and weak, and never had the courage to rebel."),
  ("npc8_home_description_2", "The tales of this fort and the great deeds of Vauban inspired me as a lass. I too wish too be a captain of men."),
  ("npc9_home_description_2", "Just as the Poles can call on their kinfolk in Russia, so does the Austrian king call on his kinfolk from over the mountains. Had my father not disinherited me, I would also have taken an oath of fealty to the lord of Vienna. But just as I was shorn of my inheritance, so also was I shown of my obligations, and it is the Austrian king's loss."),
  ("npc10_home_description_2", "We grow cattles here for cheese. We take it to Amsterdam where they sell it abroad -- not that I have ever had enough denars in my pocket to buy cattle, mind. But the craftsmen of Amsterdam also make good muskets, and for that I'll not begrudge them their little luxuries"),
  ("npc11_home_description_2", "The French king will tell you that Paris is the biggest city in Europe, and that's why he should rule the whole land today. Mind you, I don't care much about politics, {sir/madame} -- I've sold provisions to every army that ever marched in Europe, and I tell you that I wouldn't give a single one of them a single biscuit unless I had the cold, hard shillings in my hand first. Why these high and mighty kings and nobles can't pay their bills, I'll never know. But I prattle on a bit, there, don't I?"),
  ("npc12_home_description_2", "The difference between poison and cure is the dose. You tell that to everyone you meet, and tell them you heard it first from Phineas the Great. People think that all the wisdom worth knowing was written in Old Latin, but I say you can learn twice as much from village midwives and careful examination of nature than from the entire imperial corpus. That's why they threw me out of the university, although in retrospect that was a blessing. Anyway, I put that lord back on his feet, and he availed me of a sack of gold and the corpse of a freshly hanged criminal to dissect. Ha! To think of the lengths I had to go to get specimens back in those days."),
  ...
  ("npc14_home_description_2", "If anyone were ever to unify this little land of ours, I'd sign up to serve them, free of charge. I'd put together an army of Dutch pike with Swedish footmen on the flanks and English muskets in front, take along some Hungarian scouts to find and fix the enemy, and some French lancers and Ottoman mamlukes to finish them off. I'd take that army over the mountains and make the whole world kneel to Europe.... Of course, that's what the Emperors thought, and in the end the tribes took away their Empire."),
  ("npc15_home_description_2", "And here's the funny thing -- when the Cossack lands first rebelled against the Poles, they all said they weren't going to have any noble lords ruling over them. You can guess how long that lasted. One Cossack steppe chieftain sets himself up in Khymelnitsky, calls himself 'Count', and the good burghers of Warsaw and Moscow have to lick his boots if they want to sell their wine and velvet outside Europe. And if you want to keep the counts under control, and the peasants providing the towns with food rather than selling to the highest bidder, then you need a King too, don't you? The Cossack lands are no different than anyone else, whatever guff they talk about 'ancient liberties' and 'freedom.'"),
  ("npc16_home_description_2", "Still, it was a thin living, and there were always too many mouths around to feed. The English king and the French king don't make life any easier for us, squeezing for tax money the villages they control, and raiding for plunder the villages they don't. Of course, I can't say I wouldn't do the same if I had a castle and an army all of my own. The mighty do whatever they can, and the humble do whatever they must."),
  ("npc17_home_description_2", "The Archduke, Charles, has promised us freedom from the taxes and oppression. I can only pray the man holds to his word upon our victory."),
  ("npc18_home_description_2", "Still, it was a thin living, and there were always too many mouths around to feed. The Vaegir king and the Khergit khan don't make life any easier for us, squeezing for tax money the villages they control, and raiding for plunder the villages they don't. Of course, I can't say I wouldn't do the same if I had a castle and an army all of my own. The mighty do whatever they can, and the humble do whatever they must."),
  ("npc19_home_description_2", "Still, it was a thin living, and there were always too many mouths around to feed. The Vaegir king and the Khergit khan don't make life any easier for us, squeezing for tax money the villages they control, and raiding for plunder the villages they don't. Of course, I can't say I wouldn't do the same if I had a castle and an army all of my own. The mighty do whatever they can, and the humble do whatever they must."),

  ("npc1_home_recap", "I'm from the high plain, near {s21}."),
  ("npc2_home_recap", "I was born over the mountains.  I'm a student, the son of a merchant, and the grandson of a merchant."),
  ("npc3_home_recap", "I used to live in my father's house in {s20}, but I spent much of my childhood in {s21}."),
  ("npc4_home_recap", "Our ancestral barony is over the mountains, across the Toledo pass."),
  ("npc5_home_recap", "I was born in the highlands on the other side of the mountains, past Dublin, but I have relatives in {s21}."),
  ...
  ("npc8_home_recap", "I was born in France."),
  ("npc9_home_recap", "I am from the Czech homeland over the mountains, where the Magyar lords lived before the Emperor brought them in Europe."),
  ("npc10_home_recap", "Born and raised in Nijmegan, {Brother/Sister}, and I hope some day to buy land there. But I had a mind to see a bit of the world first, so I took my Musket and went off to the wars."),
  ("npc11_home_recap", "I was born in Dublin. I've lived all my days in the tavern of my father. My folk are from Dublin, however, so I guess that's as much home to me as anywhere."),
  ("npc12_home_recap", "I come from London. I travel the world in search of medical lore."),
  ...
  ("npc14_home_recap", "I am a count of the Duchy of Milan."),
  ("npc15_home_recap", "I'm from Russia. But Europe is where the money is to be made, these days, if your trade is siegecraft."),
  ("npc16_home_recap", "Why, captain, I was born in Calais village, but my mother lost her land to a scheming relative and had to put herself in bond to a nearby lord."),
  ("npc17_home_recap", "Well, I was born in La Vila Joiosa, but Valencia is my real home. I'm a widow due to the tyranny of Philip V, and I seek to end that man's reign, king or not."),
  ("npc18_home_recap", "Why, captain, I was born in Uslum village, but my mother lost her land to a scheming relative and had to put herself in bond to a nearby lord."),
  ("npc19_home_recap", "Why, captain, I was born in Uslum village, but my mother lost her land to a scheming relative and had to put herself in bond to a nearby lord."),
  ...
  ("npc13_honorific", "my captain"), #nizar
  ("npc14_honorific", "commander"), #lazalit
  ("npc15_honorific", "captain"), #artimenner
  ("npc16_honorific", "captain"), #klethi
  ("npc17_honorific", "commander"), #klethi
  ("npc18_honorific", "captain"), #klethi
  ("npc19_honorific", "captain"), #klethi

  ("npc1_kingsupport_1", "That's a great idea, captain. All these kings and emperors and landed nobles who rule now, with their prisons and gibbets and scaffolds, the whippings and brandings and hangings for any man who might be driven by the crying of his children to steal a loaf of bread, or maybe a horse -- Europe deserves something better"), #Borcha
  ("npc2_kingsupport_1", "Well, captain -- I'd support you. I think you'd give Europe the kind of enlightened rule which it has long needed."), #marnid
  ...
  ("npc17_kingsupport_1", "Ah, of course I do, and I think you would make a fine {king/queen} -- provided, of course, that you do not bring suffering to the people of Europe."), #klethi
  ("npc18_kingsupport_1", "Why not, captain? I'm sure you'd make a fine {king/queen} -- and of course I'd hope you remember the little people like myself who did you a pretty turn on your scramble to the throne."), #klethi
  ("npc19_kingsupport_1", "Why not, captain? I'm sure you'd make a fine {king/queen} -- and of course I'd hope you remember the little people like myself who did you a pretty turn on your scramble to the throne."), #klethi


  ("npc1_kingsupport_2", "Sure would, captain. But let me tell you what might bring others to your cause -- particularly us poor folk. They tell us that in the old days, each new emperor who took the throne would issue a great amnesty for all but the worst prisoners in his dungeons, give people a second chance to make something of themselves -- like you gave me a second chance, captain."), #Borcha
  ...
  ("npc9_kingsupport_2", "I would, {sir/madame}, and others would too. But here's what I think -- you need to show the noble lords that you'll uphold their ancient rights. Right now, Europe's a mess -- the lord owns the land, except it's the king who owns the forest, but the city has the right to levy tax at its gates, and the commons can use the pastures on odd Tuesdays, except in Rivacheg when it's Wednesday. Who can remember? So I say you make things simple, like it was in the old days -- first the {king/sovereign}, then the lords, then everyone else."), #Alayen
  ("npc10_kingsupport_2", "Certainly, {Brother/Sister}. But I'd ask that you consider a thought of mine. If you became {king/queen}, then I'd ask you open your court to the common folks, and not just to the lords and blue-bloods. I'd ask you to let it be known that should any man be judged and sentenced, that he have the right to appeal to you directly. Right now, the lords have the right -- I say every man in Europe should have it, too."), #Bunduk
  ...
  ("npc14_kingsupport_2", "I would indeed, sir. I think you can unite this land, and then we'll be able to raise an army such as Europe has not seen for many generations -- Swadian lances, Vaegir archers, Rhodok spears, Sarranid swords, Nord axes, and Khergit skirmishers, and take it over the mountains to subdue all the lands that the Calradic emperors once held sway."), #lazalit
  ...
  ("npc17_kingsupport_2", "It is my pleasure. One day, we will toast to our victor, fondly reminiscencing over these things."), #klethi
  ("npc18_kingsupport_2", "Of course, my {lord/lady}. And what's more, I figure a girl like me could do you a bit of a service raising support with the lords of this land. I may have only had a small part in their schemes and intrigues over the years, but I think I know what they want. And given what I know of their secrets, they'd not want to be denying me admission to their halls, now would they?"), #klethi
  ("npc19_kingsupport_2", "Of course, my {lord/lady}. And what's more, I figure a girl like me could do you a bit of a service raising support with the lords of this land. I may have only had a small part in their schemes and intrigues over the years, but I think I know what they want. And given what I know of their secrets, they'd not want to be denying me admission to their halls, now would they?"), #klethi
  ...
  ("npc17_kingsupport_2a", "I intend to do so. Thank you."), #klethi
  ("npc18_kingsupport_2a", "Interesting... Please continue"), #klethi
  ("npc19_kingsupport_2a", "Interesting... Please continue"), #klethi
  ...
  ("npc17_kingsupport_2b", "You don't think I'd wage war upon Europe and not make it my own, do you? Enough."), #klethi
  ("npc18_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
  ("npc19_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi

  ("npc1_kingsupport_3", "If I could go about this land for a few weeks, telling the common folk that you were going to amnesty their kinfolk like the emperors of old -- well, they would start talking of you as the Emperor, and that would pave your way to the throne. Shall I do that, captain?"), #Borcha
  ...
  ("npc8_kingsupport_3", "Good! Then give me a few weeks and I'll go about the courts of this land, letting it be known that you're a {king/ruler} who respects the thegns and their ancient rights. You won't go sticking your royal nose where it doesn't belong, and Europe will be the better for it."), #matheld
  ...
  ("npc17_kingsupport_3", "Well, commander, if you will give me a furlough for a few weeks, I can make my way to Barcelona and gather support amongst the communities there."), #klethi
  ("npc18_kingsupport_3", "Give me leave for a few weeks, and I'll do a little tour of my former employers' castles. I'll sing them a pretty song about what you'll do as {king/queen}, about all the ancient freedoms you'll restore -- let them rob their tenants and tax the merchants and fight their wars and spend themselves silly without a thought to tomorrow, as a noble ought! What do you say to that, captain?"), #klethi
  ("npc19_kingsupport_3", "Give me leave for a few weeks, and I'll do a little tour of my former employers' castles. I'll sing them a pretty song about what you'll do as {king/queen}, about all the ancient freedoms you'll restore -- let them rob their tenants and tax the merchants and fight their wars and spend themselves silly without a thought to tomorrow, as a noble ought! What do you say to that, captain?"), #klethi
  

  ("npc1_kingsupport_objection", "Captain -- you've given leave to Cyril Maly to go tell the nobles that they will have rights over pasture, market, and forest? I can't say I like that. Give him his way, and he'll set up gibbets in every village in the land, where there will dangle some poor sod like me who thought he might pick up a bow, head to the woods and put a bit of meat on his table."), #Borcha
  ...
  ("npc14_kingsupport_objection", "I understand that you've sent your man Borcha to proclaim to all Europe that you intend to free all the miscreants of this land upon your accession to the throne. What a foul idea... Men must be governed, {sir/madame} -- with whips and chains and the noose, if necessary. You'll find that out the hard way if you become {king/queen}, I'll warrant."), #lezalit
  ("npc15_kingsupport_objection", "I understand that you've given leave to Katrin to spread some nonsense about marks on your hands. I just want to say that, as an educated man, I find it disturbing that you would resort to old women's superstitions to back your claim. Village women will believe one thing one day, another thing the next. Now a horoscope, properly cast by an astrologer at a royal university with a reputation to uphold, might tell you something worth knowing, but those have not been performed in Europe for some time."), #artimenner
  ("npc16_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Europe on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc17_kingsupport_objection", "Commander, I hope that you're aware that Moliere Petain is off telling Europe how you've come to side with the Bourbons. I trust that this is a ruse for us to gather support only to crush them."), #klethi
  ("npc18_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Europe on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc19_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Europe on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi

#
  ("npc1_intel_mission", "Well, Captain, as it happens, I have a few cousins over in {s17}, and unlike some in my family, they can still stand the sight of me. They have different jobs. Some are merchants, but some do even fight for freedom. So some of them get to pick up a bit of the gossip round the castles and chateaus of the {s18}. I could go over there for a few days and tell you what I find out."), #Borcha
  ...
  ("npc17_intel_mission", "If you'd like, commander, I could head back to {s17} and see what I can gather for you?."), #klethi
  ("npc18_intel_mission", "Oy, Captain! I had a mind to pay a visit to my old haunts at {s17}. Let's just say that the lord and lady of the place had commissioned a certain service from me, and had been a bit lax about payment. However, a certain sparkly bauble in the lady's possession will fit the bill nicely. I see no need to trouble them by letting them know about my visit, but I could have a wee chat with my old friend the castle steward, who'll be letting me into the place, about goings-on in the {s18}."), #klethi
  ("npc19_intel_mission", "Oy, Captain! I had a mind to pay a visit to my old haunts at {s17}. Let's just say that the lord and lady of the place had commissioned a certain service from me, and had been a bit lax about payment. However, a certain sparkly bauble in the lady's possession will fit the bill nicely. I see no need to trouble them by letting them know about my visit, but I could have a wee chat with my old friend the castle steward, who'll be letting me into the place, about goings-on in the {s18}."), #klethi


  ("npc1_fief_acceptance", "You'd make me lord of {s17}, captain? Well, that would be the kindest thing that anyone has ever done for me in a long time. Heh. I'll make the most of it -- you can count on that. I have to say, though -- I'm not sure how the other lords of this realm will react, when they find a highwayman in their august company."), #Borcha
  ...
  ("npc4_fief_acceptance", "It is good of you to grant me {s17} as a fief -- and most appropriate. Proud indeed is the king who has a baron of the House of Rolf as {his/her} officer."), #rolf
  ...
  ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and give it a reputation that strikes fear in the hearts of thieves and brigands across Europe. Thank you, {sire/madame}, for this opportunity."), #deshavi
  ...
  ("npc11_fief_acceptance", "Ay! You'd grant old Katrin a title of nobility? Well, I'd be daft to turn you down, now wouldn't I? My, the strange turns that life takes... Fancy this old bag of bones becoming a great peer of the realm of Europe."), #katrin
  ("npc12_fief_acceptance", "Well, {sire/my lady}, I'd have you know that don't believe in the holding of land in fief to the king. Farmers and landholders should govern their own affairs, under the distant watch of the sovereign. That being said, Europe has seen far too much bloodshed for us to turn the social order on its head right now. Give me that land, and I'll endeavor to prepare it for a brighter future -- if not in this generation, than perhaps in the next."), #jeremus
  ...
  ("npc14_fief_acceptance", "You do me a great honor, captain. In Geroia, a youngest son such as myself has few opportunities to earn a fief of his own. But here, in Europe, there is still the chance for a man to win with his sword what was denied him by his birth! I shall hold {s17} as your officer, and raise an army to fight for your glory and for mine."), #lazalit
  ...
  ("npc17_fief_acceptance", "Commander, that is most gracious of you. Being put in charge of {s17}, I shall endeavour to ensure law and order are maintained, and that the people are not extorted. Thank you."), #klethi
  ("npc18_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi
  ("npc19_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi
  ...
  ("npc7_woman_to_woman", "Captain. If you don't mind me saying, you have fought long and hard against the scum of Europe, and with their defeat, you make this land a better place. You are well deserving of a fief of your own -- and I suspect that if you were not a woman, a king would have offered you one by now. That is the way of the men in this sorry land: they let us stand in the front of the battleline to take the enemy's blows, but when it comes to a division of the spoils, they expect us to head to the rear."), #deshavi
  ("npc8_woman_to_woman", "Excuse me, {playername}. I would like to offer you my congratulations -- it seems that you are well on your way to making a name for yourself as a warrior to be feared. If you were a man, I suspect the kings of this land would be falling over themselves to make you their general. Alas, in this world, women like ourselves must fight twice as hard to receive what is only our due."), #matheld
  ...
  ("npc17_woman_to_woman", "{!}."), #Ramon
  ("npc18_woman_to_woman", "{!}."), #klethi
  ("npc19_woman_to_woman", "Captain, although this is a man's world, I think you have shown an ability to be sung amongst the greats of history as commanders. If were you a man, surely you would be in command of greater places, Inshallah."), #klethi
  ...
  ("npc10_turn_against", "Well, it looks like the tides of fate have led me to make war on my old captain. Maybe things started to go wrong when you became my liege -- I suppose I was never much suited to command. Anyway, here we are now. Maybe, when the world is changed and there are no more masters and servants, or lords and officers, then we can meet together as friends."), #bunduk
  ...
  ("npc13_turn_against", "It is sad to meet you as my enemy, Captain -- but on the other hand, to meet such a titan of the battlefield as yourself in combat is a rare privilege. Truly, the news of our contest today shall keep the bards and poets of Europe in wine and silver for months to come, do you think?"), #nizar
  ("npc14_turn_against", "Well, {playername}. We meet as enemies. I confess that I have mixed feelings. It grieves me to make war on you, but if we meet in battle and I prevail, I will have defeated the worthiest foe in all Europe, and I will know that my mastery of the military art is complete!"), #lazalit
  ...
  ("npc17_turn_against", "Hmm. Trust me when I say this, {playername}, this is not how I had expected us to end up meeting again. I pray you do not think this personal."), #klethi
  ("npc18_turn_against", "Hello, Captain! So, I guess we're enemies! One small word of warning if we end up fighting each other -- once the rage of battle hits me, I can't always account for my actions. Just know that whatever I do, it's not personal. Maybe if we both walk away from this, we can meet once more as friends?"), #klethi
  ("npc19_turn_against", "Hello, Captain! So, I guess we're enemies! One small word of warning if we end up fighting each other -- once the rage of battle hits me, I can't always account for my actions. Just know that whatever I do, it's not personal. Maybe if we both walk away from this, we can meet once more as friends?"), #klethi
...
#courtship
  ...
  ("kingdom_2_adjective",                     "British"),
  ("kingdom_3_adjective",                     "Austrian Habsburg"),
  ("kingdom_4_adjective",                     "Bavarian"),
  ("kingdom_5_adjective",                     "Dutch"),
  ("kingdom_6_adjective",                     "Bourbon Spanish"),
  ("kingdom_7_adjective",                     "Danish"),
  ("kingdom_8_adjective",                     "Swedish"),
  ("kingdom_9_adjective",                     "Prussian"),
  ("kingdom_10_adjective",                    "Habsburg Spanish"),
  ("kingdom_11_adjective",                    "Polish"),
  ("kingdom_12_adjective",                    "Russian"),
  ("kingdom_13_adjective",                    "Player Faction"),
 # ("kingdom_14_adjective",                    "Hungarian Rebels"),
  ("kingdom_15_adjective",                    "Ottoman"),
...
#multiplayer game type names
  ...
  ("bavarians", "Bavarian"),
  ("dutch", "Dutch"),
  ("bourbons", "Spanish Bourbons"),
  ("danish", "Danish"),
  ("swedish", "Sweden"),
  ("prussians", "Prussia"),
  ("habsburgs", "Spanish Habsburgs"),
  ("polish", "Polish"),
  ("russians","Russian"),
  ("ottomans","Ottoman"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_female_2", "Countess {s0}"),
  ("faction_title_female_3", "Countess{s0}"),
  ("faction_title_female_4", "Countess {s0}"),
  ("faction_title_female_5", "Countess {s0}"),
  ("faction_title_female_6", "Countess {s0}"),
 ...
 ("journey_to_reyvadin", "You have come through the Scottish highlands, your carriage poorly exposed to the bitter winds from the north. The land here is frozen this time of the year, but it is late winter now and soon the thaw will come. On your journey through Scotland and the north of England you note that some men seem disgruntled and speak of a rightful King in exile. You saw the occasional dark figure, highwayman or Jacobite, you cannot tell which, mounted on a dark steed, watching the passage of your carriage from a snowy ridge, and were glad when the spires of London came into view across the wide valley of the Thames river."),

 ("journey_to_praven", "You came by carriage through the heartland of France. Green shoots of wheat, barley and oats are beginning to push through the dark soil of the rolling hills, and on the lower slopes of the snowcapped mountains, herds of cattle and sheep are grazing on the spring grass. The land here is rich -- but also troubled by the growing poverty of the peasants, starved by Louis's wars and angered by his persecution of their protestant brothers. The misery you see in the French countryside is troubling, and it is some relief when you crest a ridge and catch sight of the great city of Paris, its rooftops made golden by the last rays of the setting sun."),

  ("journey_to_jelkala", "You came by a wealthy merchant ship, furtively slipping past strange ships, that might be French privateers, in the night. Much of the coastline was obscured by tendrils of fog that snaked down the river valleys, but occasionally you caught sight of a fort watchtower rising above the mists -- and on one occasion, a beacon fire burning to warn of an enemy warship. You knew that you were not safe at sea, as long as French pirates preyed on Dutch shipping so it was a great relief to reach the port of Den Haag, and see a Dutch frigate riding at anchor, its pennants fluttering in the evening breeze."),

  ("journey_to_sargoth", "You took passage with a carriage in Milan that brought you, over the snowy alpine passes, and into the land of the Elector of Bavaria. Men spoke to you in taverns of the Electors decision to renounce his allegiance to his emperor and side with the King of France. If they were for it they spoke boldly of it to you. If they were against the Elector they kept their voices low and cast suspicious looks at neighboring tables. Peasants you met on the journey feared the arrival of foreign armies to fight over their lands and their livestock. You arrived in Munich to find the city in fear of the future and the retribution of the Habsburgs."),

  ("journey_to_tulga", "You came with a trading caravan, crossing the alpine mountains that border Austria to the south, bringing spices from faraway lands to trade for wool and salt. The passes were still choked with snow, and it was hard going, but at last you crested a ridge and saw before you the rich, Austrian, farmlands below. The men of the party looked uneasily to the north for Bavarian cavalry before turning suspicious eyes to the east where the rebellious Hungarian horsemen raided the lands of the empire. Nervously your party entered the great city of Vienna. The sight of it's wealth and splendour ease the troubles of the journey from your mind."),


  ("journey_to_shariz", "You came by carriage from Barcelona. In Barcelona you left a city in ferment and preparing for war on behalf of the Austrian candidate for the Spanish throne. The countryside was uneasy too. Men ceased to refer to themselves as Spanish in the area surrounding Barcelona but instead declared themselves to be Catalan and for Austria! When you passed into Bourbon lands you saw the same urgency for war and the same expressions of fierce patriotism. Madrid, when you arrive, is a beautiful old city but one preparing for war with a, white-hot, fury. The sadness of this coming war between men who should be brothers touches you deeply."),
