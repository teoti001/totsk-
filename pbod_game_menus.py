...
do_hold = [     
        ...
        (try_end),
		(try_begin), #real deployment/positioning
			(party_slot_eq, "p_main_party", slot_party_pref_real_deployment, 1),
			(store_skill_level, reg0, skl_tactics, "trp_player"),
			(gt, reg0, 0),
			(party_set_slot, "p_main_party", slot_party_pref_real_deployment, 2),
		(try_end),
