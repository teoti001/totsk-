...
skins = [
  (
    ...
    ["man_hair_s","man_hair_m","man_hair_n","man_hair_o", "man_hair_y10", "man_hair_y12","man_hair_p","man_hair_r","man_hair_q","man_hair_v","man_hair_y9","man_hair_u","man_hair_y","man_hair_y2","man_hair_y4","hairmessy","slickedback","shortbob","straightshoulder","shortcut","shortlayer","shoulderhair","courthair","new_hair_1","woman_hair_t","woman_hair_n","new_hair_2","new_hair_3"], #man_hair_meshes ,"man_hair_y5","man_hair_y8",
    ["beard_e","beard_d","beard_k","beard_f","beard_c","beard_t","beard_u","beard_r","beard_s","beard_a"], #beard meshes ,"beard_q"
...
#     ("manface_old_2",0xffd5d5c5,["hair_white"],[0xffffcded, 0xffbbcded, 0xff99eebb]),
  ...
  (
    ...
    ["woman_hair_p","woman_hair_n","woman_hair_o","woman_hair_q","woman_hair_r","woman_hair_t","woman_hair_s","villager_hair_1","villager_hair_2","villager_hair_3","villager_hair_4","villager_hair_5","new_hair_1","new_hair_5","shortcut","maidenhair","longstraight","longshoulder","straightshoulder","ponytail","courthair","sib_curly"], #woman_hair_meshes
