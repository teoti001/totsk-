...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_staff", 0, amf_client_prediction,
   [2.0, "staff_cstance_new", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 ["stand_crossbow", 0, amf_client_prediction,
   [3.0, "staff_cstance_new", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 #TOTSK
 ...
 ["turn_right_greatsword", acf_enforce_lowerbody, amf_play|amf_client_prediction,
   [0.95, "turn_man_staff_new", 0, 20, arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
 ["turn_left_greatsword", acf_enforce_lowerbody, amf_play|amf_client_prediction,
   [0.95, "turn_man_staff_new", 30, 50, arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
##   [0.8, "run_crossright_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "run_forward_right_staff_new", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [0.8, "run_crossleft_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "run_forward_left_staff_new", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
# duration and controlled via weapon speed.
 ...
 ["reload_crossbow_horseback", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [4.3, "musket_reload_revised", 1, 321, arf_blend_in_8|arf_make_custom_sound], 
 ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["ready_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.5, "musket_anims_new", 1, 4, blend_in_ready],
 ],
 ["release_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.3, "musket_anims_new", 6, 25, arf_blend_in_1],
 ],
 ["reload_musket", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [6.5, "musket_reload_revised", 0, 318, arf_blend_in_8],
 ],
