    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (assign, ":cur_troop", "trp_gardes_francaises_elite"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_2"),
        (assign, ":cur_troop", "trp_british_grenadier_1st_foot_guard_elite"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_3"),
        (assign, ":cur_troop", "trp_austrian_grenadier_elite"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_4"),
        (assign, ":cur_troop", "trp_bavaria_grenadier_elite"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_5"),
        (assign, ":cur_troop", "trp_dutch_blue_guard_elite"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_6"),
        (assign, ":cur_troop", "trp_bourbon_grenadier_elite"),
      (else_try),
...
#normal_banner_begin
#            (start_presentation, "prsnt_banner_selection"), DUH: Handled in worldmap (simple trig) to avoid crash. Engine changes made this necessary.
#custom_banner_begin
#             (start_presentation, "prsnt_custom_banner"),
#          (else_try),
            (presentation_set_duration, 0),
